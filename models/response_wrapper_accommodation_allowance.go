...
func (m *ResponseWrapperAccommodationAllowance) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperAccommodationAllowance) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperAccommodationAllowance) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperAccommodationAllowance
