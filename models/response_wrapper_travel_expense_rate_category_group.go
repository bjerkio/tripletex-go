...
func (m *ResponseWrapperTravelExpenseRateCategoryGroup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTravelExpenseRateCategoryGroup) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTravelExpenseRateCategoryGroup) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTravelExpenseRateCategoryGroup
