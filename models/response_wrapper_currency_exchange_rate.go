...
func (m *ResponseWrapperCurrencyExchangeRate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperCurrencyExchangeRate) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperCurrencyExchangeRate) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperCurrencyExchangeRate
