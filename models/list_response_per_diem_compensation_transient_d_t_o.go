...
func (m *ListResponsePerDiemCompensationTransientDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponsePerDiemCompensationTransientDTO) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponsePerDiemCompensationTransientDTO) UnmarshalBinary(b []byte) error {
	var res ListResponsePerDiemCompensationTransientDTO
