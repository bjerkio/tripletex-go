...
func (m *ResponseWrapperTravelPaymentType) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTravelPaymentType) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTravelPaymentType) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTravelPaymentType
