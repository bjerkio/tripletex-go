...
func (m *ResponseWrapperTripletexCompanyModules) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTripletexCompanyModules) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTripletexCompanyModules) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTripletexCompanyModules
