...
func (m *ResponseWrapperMileageAllowance) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperMileageAllowance) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMileageAllowance) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperMileageAllowance
