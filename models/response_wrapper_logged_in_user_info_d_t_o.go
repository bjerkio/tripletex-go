...
func (m *ResponseWrapperLoggedInUserInfoDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperLoggedInUserInfoDTO) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperLoggedInUserInfoDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperLoggedInUserInfoDTO
