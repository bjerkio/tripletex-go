...
func (m *ResponseWrapperListFileIDForIncomingPaymentsDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListFileIDForIncomingPaymentsDTO) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListFileIDForIncomingPaymentsDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListFileIDForIncomingPaymentsDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListFileIDForIncomingPaymentsDTO
