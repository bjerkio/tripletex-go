...
func (m *ResponseWrapperEmploymentDetails) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperEmploymentDetails) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperEmploymentDetails) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperEmploymentDetails
