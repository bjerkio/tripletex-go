...
func (m *ResponseWrapperPurchaseOrderline) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPurchaseOrderline) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPurchaseOrderline) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperPurchaseOrderline
