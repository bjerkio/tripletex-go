...
func (m *ListResponseTripletexCompanyModules) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseTripletexCompanyModules) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseTripletexCompanyModules) UnmarshalBinary(b []byte) error {
	var res ListResponseTripletexCompanyModules
