...
func (m *ListResponseBalanceSheetAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseBalanceSheetAccount) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseBalanceSheetAccount) UnmarshalBinary(b []byte) error {
	var res ListResponseBalanceSheetAccount
