...
func (m *ResponseWrapperProjectPeriodOverallStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperProjectPeriodOverallStatus) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperProjectPeriodOverallStatus) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperProjectPeriodOverallStatus
