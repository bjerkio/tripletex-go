...
func (m *ResponseWrapperPerDiemCompensation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPerDiemCompensation) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPerDiemCompensation) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperPerDiemCompensation
