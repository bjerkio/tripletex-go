...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["MAMUT","MAMUT_WITH_WAGE","AGRO_LICENCE","AGRO_CLIENT","AGRO_DOCUMENT_CENTER","AGRO_INVOICE","AGRO_WAGE","NO1TS","NO1TS_TRAVELREPORT","NO1TS_ACCOUNTING"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
