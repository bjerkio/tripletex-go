...
func (m *ResponseWrapperEmployeeCategory) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperEmployeeCategory) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperEmployeeCategory) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperEmployeeCategory
