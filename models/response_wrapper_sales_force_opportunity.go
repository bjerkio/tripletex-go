...
func (m *ResponseWrapperSalesForceOpportunity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperSalesForceOpportunity) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperSalesForceOpportunity) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperSalesForceOpportunity
