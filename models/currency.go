...
func (m *Currency) validateChanges(formats strfmt.Registry) error {
...
func (m *Currency) validateDescription(formats strfmt.Registry) error {
...
func (m *Currency) validateFactor(formats strfmt.Registry) error {

	if swag.IsZero(m.Factor) { // not required
		return nil
	}

	if err := validate.MinimumInt("factor", "body", int64(m.Factor), 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("factor", "body", int64(m.Factor), 100, false); err != nil {
		return err
	}
