...
func (m *AccountingPeriod) validateChanges(formats strfmt.Registry) error {
...
func (m *AccountingPeriod) validateName(formats strfmt.Registry) error {
...
func (m *AccountingPeriod) validateNumber(formats strfmt.Registry) error {
	...
	if err := validate.MaximumInt("number", "body", int64(m.Number), 11, false); err != nil {
		return err
	}
