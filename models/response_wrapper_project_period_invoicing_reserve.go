...
func (m *ResponseWrapperProjectPeriodInvoicingReserve) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperProjectPeriodInvoicingReserve) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperProjectPeriodInvoicingReserve) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperProjectPeriodInvoicingReserve
