...
func (m *ResponseWrapperSalaryTransaction) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperSalaryTransaction) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperSalaryTransaction) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperSalaryTransaction
