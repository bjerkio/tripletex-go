...
func (m *ListResponseProjectSpecificRate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseProjectSpecificRate) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseProjectSpecificRate) UnmarshalBinary(b []byte) error {
	var res ListResponseProjectSpecificRate
