...
func (m *ResponseWrapperSalesForceEmployee) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperSalesForceEmployee) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperSalesForceEmployee) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperSalesForceEmployee
