...
func (m *ResponseWrapperProjectPeriodInvoiced) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperProjectPeriodInvoiced) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperProjectPeriodInvoiced) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperProjectPeriodInvoiced
