...
func (m *ResponseWrapperTravelExpenseRateCategory) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTravelExpenseRateCategory) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTravelExpenseRateCategory) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTravelExpenseRateCategory
