...
func (m *ListResponsePersonAutoCompleteDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponsePersonAutoCompleteDTO) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponsePersonAutoCompleteDTO) UnmarshalBinary(b []byte) error {
	var res ListResponsePersonAutoCompleteDTO
