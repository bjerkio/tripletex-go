...
func (m *ListResponsePerDiemCompensation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponsePerDiemCompensation) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponsePerDiemCompensation) UnmarshalBinary(b []byte) error {
	var res ListResponsePerDiemCompensation
