...
func (m *StandardTime) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateHoursPerDay(formats); err != nil {
		res = append(res, err)
	}
...
func (m *StandardTime) validateChanges(formats strfmt.Registry) error {
...
func (m *StandardTime) validateEmployee(formats strfmt.Registry) error {
...
func (m *StandardTime) validateFromDate(formats strfmt.Registry) error {
...
func (m *StandardTime) validateHoursPerDay(formats strfmt.Registry) error {

	if err := validate.Required("hoursPerDay", "body", m.HoursPerDay); err != nil {
		return err
	}
