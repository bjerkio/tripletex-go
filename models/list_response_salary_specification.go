...
func (m *ListResponseSalarySpecification) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseSalarySpecification) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseSalarySpecification) UnmarshalBinary(b []byte) error {
	var res ListResponseSalarySpecification
