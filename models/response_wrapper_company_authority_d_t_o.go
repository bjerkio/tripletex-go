...
func (m *ResponseWrapperCompanyAuthorityDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperCompanyAuthorityDTO) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperCompanyAuthorityDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperCompanyAuthorityDTO
