...
func (m *ResponseWrapperTimesheetSettings) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTimesheetSettings) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTimesheetSettings) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTimesheetSettings
