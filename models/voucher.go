...
func (m *Voucher) validateTempNumber(formats strfmt.Registry) error {

	if swag.IsZero(m.TempNumber) { // not required
		return nil
	}

	if err := validate.MinimumInt("tempNumber", "body", int64(m.TempNumber), 0, false); err != nil {
		return err
	}
