...
func (m *ResponseWrapperAccountingPeriod) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperAccountingPeriod) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperAccountingPeriod) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperAccountingPeriod
