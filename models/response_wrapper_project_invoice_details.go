...
func (m *ResponseWrapperProjectInvoiceDetails) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperProjectInvoiceDetails) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperProjectInvoiceDetails) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperProjectInvoiceDetails
