...
func (m *ResponseWrapperEmployeeTokenBundle) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperEmployeeTokenBundle) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperEmployeeTokenBundle) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperEmployeeTokenBundle
