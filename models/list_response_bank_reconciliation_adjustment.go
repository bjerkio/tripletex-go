...
func (m *ListResponseBankReconciliationAdjustment) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseBankReconciliationAdjustment) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseBankReconciliationAdjustment) UnmarshalBinary(b []byte) error {
	var res ListResponseBankReconciliationAdjustment
