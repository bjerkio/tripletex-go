...
func (m *ResponseWrapperTravelExpenseZone) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTravelExpenseZone) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTravelExpenseZone) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTravelExpenseZone
