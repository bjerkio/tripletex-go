...
func (m *ListResponseAccommodationAllowance) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseAccommodationAllowance) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseAccommodationAllowance) UnmarshalBinary(b []byte) error {
	var res ListResponseAccommodationAllowance
