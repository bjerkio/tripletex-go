...
func (m *ListResponseCompanyAutoCompleteDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseCompanyAutoCompleteDTO) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseCompanyAutoCompleteDTO) UnmarshalBinary(b []byte) error {
	var res ListResponseCompanyAutoCompleteDTO
