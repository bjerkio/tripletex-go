...
func (m *ListResponseBankReconciliationMatch) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseBankReconciliationMatch) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseBankReconciliationMatch) UnmarshalBinary(b []byte) error {
	var res ListResponseBankReconciliationMatch
