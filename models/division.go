...
func (m *Division) validateChanges(formats strfmt.Registry) error {
...
func (m *Division) validateMunicipality(formats strfmt.Registry) error {
...
func (m *Division) validateOrganizationNumber(formats strfmt.Registry) error {
