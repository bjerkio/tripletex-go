...
func (m *ListResponseSalesForceAccountInfo) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseSalesForceAccountInfo) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseSalesForceAccountInfo) UnmarshalBinary(b []byte) error {
	var res ListResponseSalesForceAccountInfo
