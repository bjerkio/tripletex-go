...
func (m *ListResponseBankReconciliationPaymentType) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseBankReconciliationPaymentType) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseBankReconciliationPaymentType) UnmarshalBinary(b []byte) error {
	var res ListResponseBankReconciliationPaymentType
