...
func (m *ResponseWrapperVoucherApprovalListElement) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperVoucherApprovalListElement) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperVoucherApprovalListElement) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperVoucherApprovalListElement
