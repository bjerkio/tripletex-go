...
func (m *ListResponseTravelExpenseRateCategory) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseTravelExpenseRateCategory) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseTravelExpenseRateCategory) UnmarshalBinary(b []byte) error {
	var res ListResponseTravelExpenseRateCategory
