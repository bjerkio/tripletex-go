...
func (m *ResponseWrapperProjectParticipant) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperProjectParticipant) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperProjectParticipant) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperProjectParticipant
