...
func (m *ResponseWrapperTravelExpenseSettings) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTravelExpenseSettings) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTravelExpenseSettings) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTravelExpenseSettings
