...
func (m *ListResponsePurchaseOrderIncomingInvoiceRelation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponsePurchaseOrderIncomingInvoiceRelation) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponsePurchaseOrderIncomingInvoiceRelation) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListResponsePurchaseOrderIncomingInvoiceRelation) UnmarshalBinary(b []byte) error {
	var res ListResponsePurchaseOrderIncomingInvoiceRelation
