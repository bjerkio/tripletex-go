...
func (m *MaventaEventDataDTO) validateID(formats strfmt.Registry) error {
...
func (m *MaventaEventDataDTO) validateNetwork(formats strfmt.Registry) error {

	if err := validate.RequiredString("network", "body", string(m.Network)); err != nil {
		return err
	}
...
func (m *MaventaEventDataDTO) validateProfiles(formats strfmt.Registry) error {
