...
func (m *ListResponseProjectPeriodMonthlyStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseProjectPeriodMonthlyStatus) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseProjectPeriodMonthlyStatus) UnmarshalBinary(b []byte) error {
	var res ListResponseProjectPeriodMonthlyStatus
