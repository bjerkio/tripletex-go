...
func (m *ResponseWrapperBankOnboardingDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperBankOnboardingDTO) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperBankOnboardingDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperBankOnboardingDTO
