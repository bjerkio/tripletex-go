...
func (m *ResponseWrapperBankReconciliation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperBankReconciliation) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperBankReconciliation) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperBankReconciliation
