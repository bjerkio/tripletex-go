...
func (m *ResponseWrapperTimesheetSalaryTypeSpecification) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTimesheetSalaryTypeSpecification) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTimesheetSalaryTypeSpecification) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTimesheetSalaryTypeSpecification
