...
func (m *ResponseWrapperSalaryCompilation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperSalaryCompilation) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperSalaryCompilation) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperSalaryCompilation
