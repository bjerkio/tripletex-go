...
func (m *ListResponseSearchCompletionDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseSearchCompletionDTO) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseSearchCompletionDTO) UnmarshalBinary(b []byte) error {
	var res ListResponseSearchCompletionDTO
