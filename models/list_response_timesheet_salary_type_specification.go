...
func (m *ListResponseTimesheetSalaryTypeSpecification) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListResponseTimesheetSalaryTypeSpecification) validateValues(formats strfmt.Registry) error {
...
func (m *ListResponseTimesheetSalaryTypeSpecification) UnmarshalBinary(b []byte) error {
	var res ListResponseTimesheetSalaryTypeSpecification
