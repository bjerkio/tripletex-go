...
func (m *ResponseWrapperBankReconciliationPaymentType) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperBankReconciliationPaymentType) validateValue(formats strfmt.Registry) error {
...
func (m *ResponseWrapperBankReconciliationPaymentType) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperBankReconciliationPaymentType
