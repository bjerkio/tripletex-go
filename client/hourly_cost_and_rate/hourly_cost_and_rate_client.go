...
func (a *Client) EmployeeHourlyCostAndRateGet(params *EmployeeHourlyCostAndRateGetParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeHourlyCostAndRateGetOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeHourlyCostAndRate_get",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for EmployeeHourlyCostAndRate_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeHourlyCostAndRatePost(params *EmployeeHourlyCostAndRatePostParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeHourlyCostAndRatePostCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeHourlyCostAndRate_post",
		Method:             "POST",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeHourlyCostAndRate_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeHourlyCostAndRatePut(params *EmployeeHourlyCostAndRatePutParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeHourlyCostAndRatePutOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeHourlyCostAndRate_put",
		Method:             "PUT",
		PathPattern:        "/employee/hourlyCostAndRate/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json; charset=utf-8"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeHourlyCostAndRate_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeHourlyCostAndRateSearch(params *EmployeeHourlyCostAndRateSearchParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeHourlyCostAndRateSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeHourlyCostAndRate_search",
		Method:             "GET",
		PathPattern:        "/employee/hourlyCostAndRate",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeHourlyCostAndRate_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
