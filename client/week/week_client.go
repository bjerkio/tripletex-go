...
func (a *Client) TimesheetWeekApproveApprove(params *TimesheetWeekApproveApproveParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetWeekApproveApproveOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TimesheetWeekApproveApprove",
		Method:             "PUT",
	...
	msg := fmt.Sprintf("unexpected success response for TimesheetWeekApproveApprove: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetWeekCompleteComplete(params *TimesheetWeekCompleteCompleteParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetWeekCompleteCompleteOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TimesheetWeekCompleteComplete",
		Method:             "PUT",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetWeekCompleteComplete: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetWeekReopenReopen(params *TimesheetWeekReopenReopenParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetWeekReopenReopenOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetWeekReopenReopen: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetWeekSearch(params *TimesheetWeekSearchParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetWeekSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetWeekSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetWeekUnapproveUnapprove(params *TimesheetWeekUnapproveUnapproveParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetWeekUnapproveUnapproveOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TimesheetWeekUnapproveUnapprove",
		Method:             "PUT",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetWeekUnapproveUnapprove: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
