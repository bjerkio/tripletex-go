...
func (o *TimesheetWeekReopenReopenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTimesheetWeekReopenReopenOK()
...
func NewTimesheetWeekReopenReopenOK() *TimesheetWeekReopenReopenOK {
	return &TimesheetWeekReopenReopenOK{}
}
...
func (o *TimesheetWeekReopenReopenOK) Error() string {
	return fmt.Sprintf("[PUT /timesheet/week/:reopen][%d] timesheetWeekReopenReopenOK  %+v", 200, o.Payload)
}

func (o *TimesheetWeekReopenReopenOK) GetPayload() *models.ResponseWrapperWeek {
	return o.Payload
}

func (o *TimesheetWeekReopenReopenOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
