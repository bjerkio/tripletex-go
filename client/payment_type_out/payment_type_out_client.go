...
func (a *Client) LedgerPaymentTypeOutGet(params *LedgerPaymentTypeOutGetParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerPaymentTypeOutGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for LedgerPaymentTypeOutGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) LedgerPaymentTypeOutListPostList(params *LedgerPaymentTypeOutListPostListParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerPaymentTypeOutListPostListCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "LedgerPaymentTypeOutListPostList",
		Method:             "POST",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for LedgerPaymentTypeOutListPostList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) LedgerPaymentTypeOutListPutList(params *LedgerPaymentTypeOutListPutListParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerPaymentTypeOutListPutListOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "LedgerPaymentTypeOutListPutList",
		Method:             "PUT",
		PathPattern:        "/ledger/paymentTypeOut/list",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json; charset=utf-8"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for LedgerPaymentTypeOutListPutList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) LedgerPaymentTypeOutPost(params *LedgerPaymentTypeOutPostParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerPaymentTypeOutPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for LedgerPaymentTypeOutPost: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) LedgerPaymentTypeOutPut(params *LedgerPaymentTypeOutPutParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerPaymentTypeOutPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for LedgerPaymentTypeOutPut: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) LedgerPaymentTypeOutSearch(params *LedgerPaymentTypeOutSearchParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerPaymentTypeOutSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for LedgerPaymentTypeOutSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
