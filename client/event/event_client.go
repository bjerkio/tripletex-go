...
type ClientService interface {
	...
	EventGet(params *EventGetParams, authInfo runtime.ClientAuthInfoWriter) (*EventGetOK, error)
...
func (a *Client) EventExample(params *EventExampleParams, authInfo runtime.ClientAuthInfoWriter) (*EventExampleOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for EventExample: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
*/
func (a *Client) EventGet(params *EventGetParams, authInfo runtime.ClientAuthInfoWriter) (*EventGetOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EventGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
