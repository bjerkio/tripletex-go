...
func (a *Client) CountryGet(params *CountryGetParams, authInfo runtime.ClientAuthInfoWriter) (*CountryGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for Country_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) CountrySearch(params *CountrySearchParams, authInfo runtime.ClientAuthInfoWriter) (*CountrySearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Country_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
