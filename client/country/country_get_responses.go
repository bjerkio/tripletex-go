...
func (o *CountryGetOK) Error() string {
	return fmt.Sprintf("[GET /country/{id}][%d] countryGetOK  %+v", 200, o.Payload)
}
...
func (o *CountryGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
