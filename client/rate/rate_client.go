...
func (a *Client) TravelExpenseRateGet(params *TravelExpenseRateGetParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpenseRateGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for TravelExpenseRate_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TravelExpenseRateSearch(params *TravelExpenseRateSearchParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpenseRateSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TravelExpenseRate_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
