...
// NewTravelExpenseRateGetParams creates a new TravelExpenseRateGetParams object
// with the default values initialized.
func NewTravelExpenseRateGetParams() *TravelExpenseRateGetParams {
	var ()
	return &TravelExpenseRateGetParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewTravelExpenseRateGetParamsWithTimeout creates a new TravelExpenseRateGetParams object
...
// NewTravelExpenseRateGetParamsWithContext creates a new TravelExpenseRateGetParams object
...
// NewTravelExpenseRateGetParamsWithHTTPClient creates a new TravelExpenseRateGetParams object
...
/*TravelExpenseRateGetParams contains all the parameters to send to the API endpoint
for the travel expense rate get operation typically these are written to a http.Request
*/
...
func (o *TravelExpenseRateGetParams) WithTimeout(timeout time.Duration) *TravelExpenseRateGetParams {
...
func (o *TravelExpenseRateGetParams) WithContext(ctx context.Context) *TravelExpenseRateGetParams {
	o.SetContext(ctx)
	return o
}
...
func (o *TravelExpenseRateGetParams) WithHTTPClient(client *http.Client) *TravelExpenseRateGetParams {
...
func (o *TravelExpenseRateGetParams) WithFields(fields *string) *TravelExpenseRateGetParams {
	o.SetFields(fields)
	return o
}
...
func (o *TravelExpenseRateGetParams) WithID(id int32) *TravelExpenseRateGetParams {
	o.SetID(id)
	return o
}
...
func (o *TravelExpenseRateGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
