...
func (o *TravelExpenseRateSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTravelExpenseRateSearchOK()
...
func NewTravelExpenseRateSearchOK() *TravelExpenseRateSearchOK {
	return &TravelExpenseRateSearchOK{}
}
...
func (o *TravelExpenseRateSearchOK) Error() string {
	return fmt.Sprintf("[GET /travelExpense/rate][%d] travelExpenseRateSearchOK  %+v", 200, o.Payload)
}

func (o *TravelExpenseRateSearchOK) GetPayload() *models.ListResponseTravelExpenseRate {
	return o.Payload
}

func (o *TravelExpenseRateSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
