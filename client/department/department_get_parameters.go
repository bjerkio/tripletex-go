...
// NewDepartmentGetParams creates a new DepartmentGetParams object
// with the default values initialized.
func NewDepartmentGetParams() *DepartmentGetParams {
	var ()
	return &DepartmentGetParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDepartmentGetParamsWithTimeout creates a new DepartmentGetParams object
...
// NewDepartmentGetParamsWithContext creates a new DepartmentGetParams object
...
// NewDepartmentGetParamsWithHTTPClient creates a new DepartmentGetParams object
...
/*DepartmentGetParams contains all the parameters to send to the API endpoint
for the department get operation typically these are written to a http.Request
*/
...
func (o *DepartmentGetParams) WithContext(ctx context.Context) *DepartmentGetParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DepartmentGetParams) WithID(id int32) *DepartmentGetParams {
	o.SetID(id)
	return o
}
