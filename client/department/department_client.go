...
func (a *Client) DepartmentListPostList(params *DepartmentListPostListParams, authInfo runtime.ClientAuthInfoWriter) (*DepartmentListPostListCreated, error) {
	...
	msg := fmt.Sprintf("unexpected success response for DepartmentList_postList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) DepartmentListPutList(params *DepartmentListPutListParams, authInfo runtime.ClientAuthInfoWriter) (*DepartmentListPutListOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for DepartmentList_putList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) DepartmentGet(params *DepartmentGetParams, authInfo runtime.ClientAuthInfoWriter) (*DepartmentGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Department_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) DepartmentPost(params *DepartmentPostParams, authInfo runtime.ClientAuthInfoWriter) (*DepartmentPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Department_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) DepartmentPut(params *DepartmentPutParams, authInfo runtime.ClientAuthInfoWriter) (*DepartmentPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Department_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) DepartmentSearch(params *DepartmentSearchParams, authInfo runtime.ClientAuthInfoWriter) (*DepartmentSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Department_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
