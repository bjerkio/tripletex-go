...
func (o *DepartmentPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewDepartmentPostCreated()
...
func (o *DepartmentPostCreated) Error() string {
	return fmt.Sprintf("[POST /department][%d] departmentPostCreated  %+v", 201, o.Payload)
}

func (o *DepartmentPostCreated) GetPayload() *models.ResponseWrapperDepartment {
	return o.Payload
}

func (o *DepartmentPostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
