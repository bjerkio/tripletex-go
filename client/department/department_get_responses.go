...
func (o *DepartmentGetOK) Error() string {
	return fmt.Sprintf("[GET /department/{id}][%d] departmentGetOK  %+v", 200, o.Payload)
}

func (o *DepartmentGetOK) GetPayload() *models.ResponseWrapperDepartment {
	return o.Payload
}

func (o *DepartmentGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
