...
func (a *Client) CustomerListPostList(params *CustomerListPostListParams, authInfo runtime.ClientAuthInfoWriter) (*CustomerListPostListCreated, error) {
	...
	msg := fmt.Sprintf("unexpected success response for CustomerList_postList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) CustomerListPutList(params *CustomerListPutListParams, authInfo runtime.ClientAuthInfoWriter) (*CustomerListPutListOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for CustomerList_putList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) CustomerDelete(params *CustomerDeleteParams, authInfo runtime.ClientAuthInfoWriter) error {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCustomerDeleteParams()
	}
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &CustomerDeleteReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
...
func (a *Client) CustomerGet(params *CustomerGetParams, authInfo runtime.ClientAuthInfoWriter) (*CustomerGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Customer_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) CustomerPost(params *CustomerPostParams, authInfo runtime.ClientAuthInfoWriter) (*CustomerPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Customer_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) CustomerPut(params *CustomerPutParams, authInfo runtime.ClientAuthInfoWriter) (*CustomerPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Customer_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) CustomerSearch(params *CustomerSearchParams, authInfo runtime.ClientAuthInfoWriter) (*CustomerSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Customer_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
