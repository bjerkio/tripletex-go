...
func (o *CustomerGetOK) Error() string {
	return fmt.Sprintf("[GET /customer/{id}][%d] customerGetOK  %+v", 200, o.Payload)
}
...
func (o *CustomerGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
