...
func (o *TimesheetSalaryTypeSpecificationGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTimesheetSalaryTypeSpecificationGetOK()
...
func NewTimesheetSalaryTypeSpecificationGetOK() *TimesheetSalaryTypeSpecificationGetOK {
	return &TimesheetSalaryTypeSpecificationGetOK{}
}
...
func (o *TimesheetSalaryTypeSpecificationGetOK) Error() string {
	return fmt.Sprintf("[GET /timesheet/salaryTypeSpecification/{id}][%d] timesheetSalaryTypeSpecificationGetOK  %+v", 200, o.Payload)
}

func (o *TimesheetSalaryTypeSpecificationGetOK) GetPayload() *models.ResponseWrapperTimesheetSalaryTypeSpecification {
	return o.Payload
}

func (o *TimesheetSalaryTypeSpecificationGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
