...
func (o *LedgerAccountPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewLedgerAccountPostCreated()
...
func NewLedgerAccountPostCreated() *LedgerAccountPostCreated {
	return &LedgerAccountPostCreated{}
}
...
func (o *LedgerAccountPostCreated) Error() string {
	return fmt.Sprintf("[POST /ledger/account][%d] ledgerAccountPostCreated  %+v", 201, o.Payload)
}
...
func (o *LedgerAccountPostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
