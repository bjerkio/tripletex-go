...
func (o *BankStatementTransactionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewBankStatementTransactionGetOK()
...
func NewBankStatementTransactionGetOK() *BankStatementTransactionGetOK {
	return &BankStatementTransactionGetOK{}
}
...
func (o *BankStatementTransactionGetOK) Error() string {
	return fmt.Sprintf("[GET /bank/statement/transaction/{id}][%d] bankStatementTransactionGetOK  %+v", 200, o.Payload)
}
...
func (o *BankStatementTransactionGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
