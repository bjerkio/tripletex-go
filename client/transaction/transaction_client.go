...
func (a *Client) BankStatementTransactionDetailsGetDetails(params *BankStatementTransactionDetailsGetDetailsParams, authInfo runtime.ClientAuthInfoWriter) (*BankStatementTransactionDetailsGetDetailsOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankStatementTransactionDetailsGetDetails",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for BankStatementTransactionDetailsGetDetails: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankStatementTransactionGet(params *BankStatementTransactionGetParams, authInfo runtime.ClientAuthInfoWriter) (*BankStatementTransactionGetOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankStatementTransactionGet",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankStatementTransactionGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankStatementTransactionSearch(params *BankStatementTransactionSearchParams, authInfo runtime.ClientAuthInfoWriter) (*BankStatementTransactionSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankStatementTransactionSearch",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankStatementTransactionSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SalaryTransactionGet(params *SalaryTransactionGetParams, authInfo runtime.ClientAuthInfoWriter) (*SalaryTransactionGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for SalaryTransactionGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SalaryTransactionPost(params *SalaryTransactionPostParams, authInfo runtime.ClientAuthInfoWriter) (*SalaryTransactionPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for SalaryTransactionPost: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
