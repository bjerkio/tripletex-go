...
func (o *TravelExpenseMileageAllowanceDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewTravelExpenseMileageAllowanceDeleteDefault(response.Code())
...
func NewTravelExpenseMileageAllowanceDeleteDefault(code int) *TravelExpenseMileageAllowanceDeleteDefault {
	return &TravelExpenseMileageAllowanceDeleteDefault{
		_statusCode: code,
	}
}
...
func (o *TravelExpenseMileageAllowanceDeleteDefault) Code() int {
	return o._statusCode
}

func (o *TravelExpenseMileageAllowanceDeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE /travelExpense/mileageAllowance/{id}][%d] TravelExpenseMileageAllowance_delete default ", o._statusCode)
}

func (o *TravelExpenseMileageAllowanceDeleteDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
