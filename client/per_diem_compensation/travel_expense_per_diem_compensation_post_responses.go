...
func (o *TravelExpensePerDiemCompensationPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewTravelExpensePerDiemCompensationPostCreated()
...
func NewTravelExpensePerDiemCompensationPostCreated() *TravelExpensePerDiemCompensationPostCreated {
	return &TravelExpensePerDiemCompensationPostCreated{}
}
...
func (o *TravelExpensePerDiemCompensationPostCreated) Error() string {
	return fmt.Sprintf("[POST /travelExpense/perDiemCompensation][%d] travelExpensePerDiemCompensationPostCreated  %+v", 201, o.Payload)
}
...
func (o *TravelExpensePerDiemCompensationPostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
