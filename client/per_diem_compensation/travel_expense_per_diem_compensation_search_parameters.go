...
func (o *TravelExpensePerDiemCompensationSearchParams) WithAmountFrom(amountFrom *string) *TravelExpensePerDiemCompensationSearchParams {
	o.SetAmountFrom(amountFrom)
	return o
}

// SetAmountFrom adds the amountFrom to the travel expense per diem compensation search params
func (o *TravelExpensePerDiemCompensationSearchParams) SetAmountFrom(amountFrom *string) {
	o.AmountFrom = amountFrom
}

// WithAmountTo adds the amountTo to the travel expense per diem compensation search params
func (o *TravelExpensePerDiemCompensationSearchParams) WithAmountTo(amountTo *string) *TravelExpensePerDiemCompensationSearchParams {
	o.SetAmountTo(amountTo)
	return o
}

// SetAmountTo adds the amountTo to the travel expense per diem compensation search params
func (o *TravelExpensePerDiemCompensationSearchParams) SetAmountTo(amountTo *string) {
	o.AmountTo = amountTo
}
...
func (o *TravelExpensePerDiemCompensationSearchParams) WithRateFrom(rateFrom *string) *TravelExpensePerDiemCompensationSearchParams {
	o.SetRateFrom(rateFrom)
	return o
}

// SetRateFrom adds the rateFrom to the travel expense per diem compensation search params
func (o *TravelExpensePerDiemCompensationSearchParams) SetRateFrom(rateFrom *string) {
	o.RateFrom = rateFrom
}

// WithRateTo adds the rateTo to the travel expense per diem compensation search params
func (o *TravelExpensePerDiemCompensationSearchParams) WithRateTo(rateTo *string) *TravelExpensePerDiemCompensationSearchParams {
	o.SetRateTo(rateTo)
	return o
}

// SetRateTo adds the rateTo to the travel expense per diem compensation search params
func (o *TravelExpensePerDiemCompensationSearchParams) SetRateTo(rateTo *string) {
	o.RateTo = rateTo
}
