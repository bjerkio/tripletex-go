...
func (a *Client) TokenConsumerByTokenGetByToken(params *TokenConsumerByTokenGetByTokenParams, authInfo runtime.ClientAuthInfoWriter) (*TokenConsumerByTokenGetByTokenOK, error) {
	...
	if params == nil {
		params = NewTokenConsumerByTokenGetByTokenParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TokenConsumerByToken_getByToken",
		Method:             "GET",
		...
		Params:             params,
		Reader:             &TokenConsumerByTokenGetByTokenReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*TokenConsumerByTokenGetByTokenOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TokenConsumerByToken_getByToken: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
