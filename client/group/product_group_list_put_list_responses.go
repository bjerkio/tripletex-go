...
func (o *ProductGroupListPutListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewProductGroupListPutListOK()
...
func NewProductGroupListPutListOK() *ProductGroupListPutListOK {
	return &ProductGroupListPutListOK{}
}
...
func (o *ProductGroupListPutListOK) Error() string {
	return fmt.Sprintf("[PUT /product/group/list][%d] productGroupListPutListOK  %+v", 200, o.Payload)
}

func (o *ProductGroupListPutListOK) GetPayload() *models.ListResponseProductGroup {
	return o.Payload
}

func (o *ProductGroupListPutListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
