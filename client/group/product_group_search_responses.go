...
func (o *ProductGroupSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewProductGroupSearchOK()
...
func (o *ProductGroupSearchOK) Error() string {
	return fmt.Sprintf("[GET /product/group][%d] productGroupSearchOK  %+v", 200, o.Payload)
}

func (o *ProductGroupSearchOK) GetPayload() *models.ListResponseProductGroup {
	return o.Payload
}

func (o *ProductGroupSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
