...
func (o *ProductGroupGetOK) Error() string {
	return fmt.Sprintf("[GET /product/group/{id}][%d] productGroupGetOK  %+v", 200, o.Payload)
}

func (o *ProductGroupGetOK) GetPayload() *models.ResponseWrapperProductGroup {
	return o.Payload
}

func (o *ProductGroupGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
