...
func (o *EmployeeEmploymentSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewEmployeeEmploymentSearchOK()
...
func NewEmployeeEmploymentSearchOK() *EmployeeEmploymentSearchOK {
	return &EmployeeEmploymentSearchOK{}
}
...
func (o *EmployeeEmploymentSearchOK) Error() string {
	return fmt.Sprintf("[GET /employee/employment][%d] employeeEmploymentSearchOK  %+v", 200, o.Payload)
}
...
func (o *EmployeeEmploymentSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
