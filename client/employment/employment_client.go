...
func (a *Client) EmployeeEmploymentGet(params *EmployeeEmploymentGetParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeEmploymentPost(params *EmployeeEmploymentPostParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentPost: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeEmploymentPut(params *EmployeeEmploymentPutParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentPut: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeEmploymentSearch(params *EmployeeEmploymentSearchParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
