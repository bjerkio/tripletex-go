...
func (o *SupplierInvoiceApproveApproveManyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSupplierInvoiceApproveApproveManyOK()
...
func NewSupplierInvoiceApproveApproveManyOK() *SupplierInvoiceApproveApproveManyOK {
	return &SupplierInvoiceApproveApproveManyOK{}
}
...
func (o *SupplierInvoiceApproveApproveManyOK) Error() string {
	return fmt.Sprintf("[PUT /supplierInvoice/:approve][%d] supplierInvoiceApproveApproveManyOK  %+v", 200, o.Payload)
}
...
func (o *SupplierInvoiceApproveApproveManyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
