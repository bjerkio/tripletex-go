...
func (o *SupplierInvoicePdfDownloadPdfReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSupplierInvoicePdfDownloadPdfOK()
...
func NewSupplierInvoicePdfDownloadPdfOK() *SupplierInvoicePdfDownloadPdfOK {
	return &SupplierInvoicePdfDownloadPdfOK{}
}
...
func (o *SupplierInvoicePdfDownloadPdfOK) Error() string {
	return fmt.Sprintf("[GET /supplierInvoice/{invoiceId}/pdf][%d] supplierInvoicePdfDownloadPdfOK  %+v", 200, o.Payload)
}
...
func (o *SupplierInvoicePdfDownloadPdfOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
