...
func (o *SupplierInvoiceRejectRejectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSupplierInvoiceRejectRejectOK()
...
func NewSupplierInvoiceRejectRejectOK() *SupplierInvoiceRejectRejectOK {
	return &SupplierInvoiceRejectRejectOK{}
}
...
func (o *SupplierInvoiceRejectRejectOK) Error() string {
	return fmt.Sprintf("[PUT /supplierInvoice/{invoiceId}/:reject][%d] supplierInvoiceRejectRejectOK  %+v", 200, o.Payload)
}
...
func (o *SupplierInvoiceRejectRejectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
