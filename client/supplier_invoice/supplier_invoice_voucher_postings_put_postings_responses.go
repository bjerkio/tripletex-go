...
func (o *SupplierInvoiceVoucherPostingsPutPostingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSupplierInvoiceVoucherPostingsPutPostingsOK()
...
func NewSupplierInvoiceVoucherPostingsPutPostingsOK() *SupplierInvoiceVoucherPostingsPutPostingsOK {
	return &SupplierInvoiceVoucherPostingsPutPostingsOK{}
}
...
func (o *SupplierInvoiceVoucherPostingsPutPostingsOK) Error() string {
	return fmt.Sprintf("[PUT /supplierInvoice/voucher/{id}/postings][%d] supplierInvoiceVoucherPostingsPutPostingsOK  %+v", 200, o.Payload)
}
...
func (o *SupplierInvoiceVoucherPostingsPutPostingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
