...
func (a *Client) TravelExpenseZoneGet(params *TravelExpenseZoneGetParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpenseZoneGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for TravelExpenseZoneGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TravelExpenseZoneSearch(params *TravelExpenseZoneSearchParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpenseZoneSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TravelExpenseZoneSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
