...
func (a *Client) BankReconciliationAdjustmentAdjustment(params *BankReconciliationAdjustmentAdjustmentParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationAdjustmentAdjustmentOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankReconciliationAdjustment_adjustment",
		Method:             "PUT",
	...
	msg := fmt.Sprintf("unexpected success response for BankReconciliationAdjustment_adjustment: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationLastClosedLastClosed(params *BankReconciliationLastClosedLastClosedParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationLastClosedLastClosedOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankReconciliationLastClosed_lastClosed",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliationLastClosed_lastClosed: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationGet(params *BankReconciliationGetParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliation_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationPost(params *BankReconciliationPostParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliation_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationPut(params *BankReconciliationPutParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliation_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationSearch(params *BankReconciliationSearchParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliation_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
