...
func (o *ProjectHourlyRatesProjectSpecificRatesListDeleteByIdsDefault) Error() string {
	return fmt.Sprintf("[DELETE /project/hourlyRates/projectSpecificRates/list][%d] ProjectHourlyRatesProjectSpecificRatesList_deleteByIds default ", o._statusCode)
}
