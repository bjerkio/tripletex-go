...
func (a *Client) CompanySalesmodulesGet(params *CompanySalesmodulesGetParams, authInfo runtime.ClientAuthInfoWriter) (*CompanySalesmodulesGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for CompanySalesmodulesGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) CompanySalesmodulesPost(params *CompanySalesmodulesPostParams, authInfo runtime.ClientAuthInfoWriter) (*CompanySalesmodulesPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for CompanySalesmodulesPost: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
