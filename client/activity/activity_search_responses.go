...
func (o *ActivitySearchOK) Error() string {
	return fmt.Sprintf("[GET /activity][%d] activitySearchOK  %+v", 200, o.Payload)
}
...
func (o *ActivitySearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
