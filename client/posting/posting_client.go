...
func (a *Client) LedgerPostingOpenPostOpenPost(params *LedgerPostingOpenPostOpenPostParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerPostingOpenPostOpenPostOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "LedgerPostingOpenPost_openPost",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for LedgerPostingOpenPost_openPost: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) LedgerPostingGet(params *LedgerPostingGetParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerPostingGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for LedgerPosting_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) LedgerPostingSearch(params *LedgerPostingSearchParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerPostingSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for LedgerPosting_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
