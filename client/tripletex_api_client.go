...
import (
	...
	"github.com/bjerkio/tripletex-go/v2/client/accommodation_allowance"
	"github.com/bjerkio/tripletex-go/v2/client/account"
	"github.com/bjerkio/tripletex-go/v2/client/accounting_period"
	"github.com/bjerkio/tripletex-go/v2/client/activity"
	"github.com/bjerkio/tripletex-go/v2/client/altinn"
	"github.com/bjerkio/tripletex-go/v2/client/annual_account"
	"github.com/bjerkio/tripletex-go/v2/client/balance_sheet"
	"github.com/bjerkio/tripletex-go/v2/client/bank"
	"github.com/bjerkio/tripletex-go/v2/client/category"
	"github.com/bjerkio/tripletex-go/v2/client/close_group"
	"github.com/bjerkio/tripletex-go/v2/client/company"
	"github.com/bjerkio/tripletex-go/v2/client/compilation"
	"github.com/bjerkio/tripletex-go/v2/client/consumer"
	"github.com/bjerkio/tripletex-go/v2/client/contact"
	"github.com/bjerkio/tripletex-go/v2/client/control_form"
	"github.com/bjerkio/tripletex-go/v2/client/cost"
	"github.com/bjerkio/tripletex-go/v2/client/cost_category"
	"github.com/bjerkio/tripletex-go/v2/client/country"
	"github.com/bjerkio/tripletex-go/v2/client/currency"
	"github.com/bjerkio/tripletex-go/v2/client/customer"
	"github.com/bjerkio/tripletex-go/v2/client/delivery_address"
	"github.com/bjerkio/tripletex-go/v2/client/department"
	"github.com/bjerkio/tripletex-go/v2/client/details"
	"github.com/bjerkio/tripletex-go/v2/client/deviation"
	"github.com/bjerkio/tripletex-go/v2/client/division"
	"github.com/bjerkio/tripletex-go/v2/client/document"
	"github.com/bjerkio/tripletex-go/v2/client/document_archive"
	"github.com/bjerkio/tripletex-go/v2/client/employee"
	"github.com/bjerkio/tripletex-go/v2/client/employment"
	"github.com/bjerkio/tripletex-go/v2/client/employment_type"
	"github.com/bjerkio/tripletex-go/v2/client/entitlement"
	"github.com/bjerkio/tripletex-go/v2/client/entry"
	"github.com/bjerkio/tripletex-go/v2/client/event"
	"github.com/bjerkio/tripletex-go/v2/client/external"
	"github.com/bjerkio/tripletex-go/v2/client/goods_receipt"
	"github.com/bjerkio/tripletex-go/v2/client/goods_receipt_line"
	"github.com/bjerkio/tripletex-go/v2/client/group"
	"github.com/bjerkio/tripletex-go/v2/client/group_relation"
	"github.com/bjerkio/tripletex-go/v2/client/holiday"
	"github.com/bjerkio/tripletex-go/v2/client/hourly_cost_and_rate"
	"github.com/bjerkio/tripletex-go/v2/client/hourly_rates"
	"github.com/bjerkio/tripletex-go/v2/client/inventories"
	"github.com/bjerkio/tripletex-go/v2/client/inventory"
	"github.com/bjerkio/tripletex-go/v2/client/invoice"
	"github.com/bjerkio/tripletex-go/v2/client/leave_of_absence"
	"github.com/bjerkio/tripletex-go/v2/client/leave_of_absence_type"
	"github.com/bjerkio/tripletex-go/v2/client/ledger"
	"github.com/bjerkio/tripletex-go/v2/client/master"
	"github.com/bjerkio/tripletex-go/v2/client/match"
	"github.com/bjerkio/tripletex-go/v2/client/mileage_allowance"
	"github.com/bjerkio/tripletex-go/v2/client/month"
	"github.com/bjerkio/tripletex-go/v2/client/municipality"
	"github.com/bjerkio/tripletex-go/v2/client/next_of_kin"
	"github.com/bjerkio/tripletex-go/v2/client/occupation_code"
	"github.com/bjerkio/tripletex-go/v2/client/order"
	"github.com/bjerkio/tripletex-go/v2/client/order_group"
	"github.com/bjerkio/tripletex-go/v2/client/orderline"
	"github.com/bjerkio/tripletex-go/v2/client/participant"
	"github.com/bjerkio/tripletex-go/v2/client/passenger"
	"github.com/bjerkio/tripletex-go/v2/client/payment_type"
	"github.com/bjerkio/tripletex-go/v2/client/payment_type_out"
	"github.com/bjerkio/tripletex-go/v2/client/payslip"
	"github.com/bjerkio/tripletex-go/v2/client/pension_scheme"
	"github.com/bjerkio/tripletex-go/v2/client/per_diem_compensation"
	"github.com/bjerkio/tripletex-go/v2/client/period"
	"github.com/bjerkio/tripletex-go/v2/client/posting"
	"github.com/bjerkio/tripletex-go/v2/client/product"
	"github.com/bjerkio/tripletex-go/v2/client/product_price"
	"github.com/bjerkio/tripletex-go/v2/client/productline"
	"github.com/bjerkio/tripletex-go/v2/client/project"
	"github.com/bjerkio/tripletex-go/v2/client/project_activity"
	"github.com/bjerkio/tripletex-go/v2/client/project_specific_rates"
	"github.com/bjerkio/tripletex-go/v2/client/prospect"
	"github.com/bjerkio/tripletex-go/v2/client/purchase_order"
	"github.com/bjerkio/tripletex-go/v2/client/purchase_order_incoming_invoice_relation"
	"github.com/bjerkio/tripletex-go/v2/client/rate"
	"github.com/bjerkio/tripletex-go/v2/client/rate_category"
	"github.com/bjerkio/tripletex-go/v2/client/rate_category_group"
	"github.com/bjerkio/tripletex-go/v2/client/reconciliation"
	"github.com/bjerkio/tripletex-go/v2/client/reminder"
	"github.com/bjerkio/tripletex-go/v2/client/remuneration_type"
	"github.com/bjerkio/tripletex-go/v2/client/salary_type_specification"
	"github.com/bjerkio/tripletex-go/v2/client/salesmodules"
	"github.com/bjerkio/tripletex-go/v2/client/session"
	"github.com/bjerkio/tripletex-go/v2/client/settings"
	"github.com/bjerkio/tripletex-go/v2/client/standard_time"
	"github.com/bjerkio/tripletex-go/v2/client/statement"
	"github.com/bjerkio/tripletex-go/v2/client/stocktaking"
	"github.com/bjerkio/tripletex-go/v2/client/subscription"
	"github.com/bjerkio/tripletex-go/v2/client/supplier"
	"github.com/bjerkio/tripletex-go/v2/client/supplier_invoice"
	"github.com/bjerkio/tripletex-go/v2/client/task"
	"github.com/bjerkio/tripletex-go/v2/client/time_clock"
	"github.com/bjerkio/tripletex-go/v2/client/transaction"
	"github.com/bjerkio/tripletex-go/v2/client/transport_type"
	"github.com/bjerkio/tripletex-go/v2/client/travel_expense"
	"github.com/bjerkio/tripletex-go/v2/client/travel_expensezone"
	"github.com/bjerkio/tripletex-go/v2/client/type_operations"
	"github.com/bjerkio/tripletex-go/v2/client/unit"
	"github.com/bjerkio/tripletex-go/v2/client/vat_type"
	"github.com/bjerkio/tripletex-go/v2/client/voucher"
	"github.com/bjerkio/tripletex-go/v2/client/voucher_approval_list_element"
	"github.com/bjerkio/tripletex-go/v2/client/voucher_message"
	"github.com/bjerkio/tripletex-go/v2/client/voucher_status"
	"github.com/bjerkio/tripletex-go/v2/client/voucher_type"
	"github.com/bjerkio/tripletex-go/v2/client/week"
	"github.com/bjerkio/tripletex-go/v2/client/working_hours_scheme"
)
...
// NewHTTPClientWithConfig creates a new tripletex API HTTP client,
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *TripletexAPI {
	...
	cli.BalanceSheet = balance_sheet.New(transport, formats)
	...
	cli.Master = master.New(transport, formats)
	...
	cli.OrderGroup = order_group.New(transport, formats)
	...
	cli.PensionScheme = pension_scheme.New(transport, formats)
	...
	cli.ProductPrice = product_price.New(transport, formats)
	...
	cli.PurchaseOrderIncomingInvoiceRelation = purchase_order_incoming_invoice_relation.New(transport, formats)
	...
	cli.TransportType = transport_type.New(transport, formats)
	...
	cli.VoucherApprovalListElement = voucher_approval_list_element.New(transport, formats)
	cli.VoucherMessage = voucher_message.New(transport, formats)
	cli.VoucherStatus = voucher_status.New(transport, formats)
...
func (c *TripletexAPI) SetTransport(transport runtime.ClientTransport) {
	...
	c.BalanceSheet.SetTransport(transport)
	...
	c.Master.SetTransport(transport)
	...
	c.OrderGroup.SetTransport(transport)
	...
	c.PensionScheme.SetTransport(transport)
	...
	c.ProductPrice.SetTransport(transport)
	...
	c.PurchaseOrderIncomingInvoiceRelation.SetTransport(transport)
	...
	c.TransportType.SetTransport(transport)
	...
	c.VoucherApprovalListElement.SetTransport(transport)
	c.VoucherMessage.SetTransport(transport)
	c.VoucherStatus.SetTransport(transport)
