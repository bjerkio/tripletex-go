...
func (o *InventoryStocktakingProductlineSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewInventoryStocktakingProductlineSearchOK()
...
func NewInventoryStocktakingProductlineSearchOK() *InventoryStocktakingProductlineSearchOK {
	return &InventoryStocktakingProductlineSearchOK{}
}
...
func (o *InventoryStocktakingProductlineSearchOK) Error() string {
	return fmt.Sprintf("[GET /inventory/stocktaking/productline][%d] inventoryStocktakingProductlineSearchOK  %+v", 200, o.Payload)
}
...
func (o *InventoryStocktakingProductlineSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ListResponseProductLine)
