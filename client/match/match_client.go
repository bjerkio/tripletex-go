...
func (a *Client) BankReconciliationMatchDelete(params *BankReconciliationMatchDeleteParams, authInfo runtime.ClientAuthInfoWriter) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankReconciliationMatchDelete",
		Method:             "DELETE",
...
func (a *Client) BankReconciliationMatchGet(params *BankReconciliationMatchGetParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationMatchGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for BankReconciliationMatchGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationMatchPost(params *BankReconciliationMatchPostParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationMatchPostCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankReconciliationMatchPost",
		Method:             "POST",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliationMatchPost: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationMatchPut(params *BankReconciliationMatchPutParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationMatchPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliationMatchPut: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationMatchSearch(params *BankReconciliationMatchSearchParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationMatchSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankReconciliationMatchSearch",
		Method:             "GET",
		PathPattern:        "/bank/reconciliation/match",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliationMatchSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationMatchSuggestSuggest(params *BankReconciliationMatchSuggestSuggestParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationMatchSuggestSuggestOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankReconciliationMatchSuggestSuggest",
		Method:             "PUT",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliationMatchSuggestSuggest: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
