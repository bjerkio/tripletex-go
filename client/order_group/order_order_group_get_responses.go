...
func (o *OrderOrderGroupGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewOrderOrderGroupGetOK()
...
func (o *OrderOrderGroupGetOK) Error() string {
	return fmt.Sprintf("[GET /order/orderGroup/{id}][%d] orderOrderGroupGetOK  %+v", 200, o.Payload)
}

func (o *OrderOrderGroupGetOK) GetPayload() *models.ResponseWrapperOrderGroup {
	return o.Payload
}

func (o *OrderOrderGroupGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
