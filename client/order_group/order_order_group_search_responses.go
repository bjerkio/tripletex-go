...
func (o *OrderOrderGroupSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewOrderOrderGroupSearchOK()
...
func NewOrderOrderGroupSearchOK() *OrderOrderGroupSearchOK {
	return &OrderOrderGroupSearchOK{}
}
...
func (o *OrderOrderGroupSearchOK) Error() string {
	return fmt.Sprintf("[GET /order/orderGroup][%d] orderOrderGroupSearchOK  %+v", 200, o.Payload)
}

func (o *OrderOrderGroupSearchOK) GetPayload() *models.ListResponseOrderGroup {
	return o.Payload
}

func (o *OrderOrderGroupSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ListResponseOrderGroup)
