...
func (a *Client) TimesheetMonthApproveApprove(params *TimesheetMonthApproveApproveParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetMonthApproveApproveOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TimesheetMonthApprove_approve",
		Method:             "PUT",
	...
	msg := fmt.Sprintf("unexpected success response for TimesheetMonthApprove_approve: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetMonthByMonthNumberGetByMonthNumber(params *TimesheetMonthByMonthNumberGetByMonthNumberParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetMonthByMonthNumberGetByMonthNumberOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TimesheetMonthByMonthNumber_getByMonthNumber",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetMonthByMonthNumber_getByMonthNumber: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetMonthCompleteComplete(params *TimesheetMonthCompleteCompleteParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetMonthCompleteCompleteOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TimesheetMonthComplete_complete",
		Method:             "PUT",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetMonthComplete_complete: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetMonthReopenReopen(params *TimesheetMonthReopenReopenParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetMonthReopenReopenOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TimesheetMonthReopen_reopen",
		Method:             "PUT",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetMonthReopen_reopen: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetMonthUnapproveUnapprove(params *TimesheetMonthUnapproveUnapproveParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetMonthUnapproveUnapproveOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TimesheetMonthUnapprove_unapprove",
		Method:             "PUT",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetMonthUnapprove_unapprove: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetMonthGet(params *TimesheetMonthGetParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetMonthGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetMonth_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
