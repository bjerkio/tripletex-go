...
func (o *PurchaseOrderGoodsReceiptDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewPurchaseOrderGoodsReceiptDeleteDefault(response.Code())
...
func NewPurchaseOrderGoodsReceiptDeleteDefault(code int) *PurchaseOrderGoodsReceiptDeleteDefault {
	return &PurchaseOrderGoodsReceiptDeleteDefault{
		_statusCode: code,
	}
}
...
func (o *PurchaseOrderGoodsReceiptDeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE /purchaseOrder/goodsReceipt/{id}][%d] PurchaseOrderGoodsReceipt_delete default ", o._statusCode)
}

func (o *PurchaseOrderGoodsReceiptDeleteDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
