...
func (o *PurchaseOrderGoodsReceiptPutReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPurchaseOrderGoodsReceiptPutOK()
...
func NewPurchaseOrderGoodsReceiptPutOK() *PurchaseOrderGoodsReceiptPutOK {
	return &PurchaseOrderGoodsReceiptPutOK{}
}
...
func (o *PurchaseOrderGoodsReceiptPutOK) Error() string {
	return fmt.Sprintf("[PUT /purchaseOrder/goodsReceipt/{id}][%d] purchaseOrderGoodsReceiptPutOK  %+v", 200, o.Payload)
}
...
func (o *PurchaseOrderGoodsReceiptPutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
