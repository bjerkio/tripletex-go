...
func (o *PurchaseOrderGoodsReceiptGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPurchaseOrderGoodsReceiptGetOK()
...
func NewPurchaseOrderGoodsReceiptGetOK() *PurchaseOrderGoodsReceiptGetOK {
	return &PurchaseOrderGoodsReceiptGetOK{}
}
...
func (o *PurchaseOrderGoodsReceiptGetOK) Error() string {
	return fmt.Sprintf("[GET /purchaseOrder/goodsReceipt/{id}][%d] purchaseOrderGoodsReceiptGetOK  %+v", 200, o.Payload)
}
...
func (o *PurchaseOrderGoodsReceiptGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
