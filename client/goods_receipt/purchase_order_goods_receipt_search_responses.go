...
func (o *PurchaseOrderGoodsReceiptSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPurchaseOrderGoodsReceiptSearchOK()
...
func NewPurchaseOrderGoodsReceiptSearchOK() *PurchaseOrderGoodsReceiptSearchOK {
	return &PurchaseOrderGoodsReceiptSearchOK{}
}
...
func (o *PurchaseOrderGoodsReceiptSearchOK) Error() string {
	return fmt.Sprintf("[GET /purchaseOrder/goodsReceipt][%d] purchaseOrderGoodsReceiptSearchOK  %+v", 200, o.Payload)
}
...
func (o *PurchaseOrderGoodsReceiptSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
