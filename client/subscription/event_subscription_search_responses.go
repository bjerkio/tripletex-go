...
func (o *EventSubscriptionSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewEventSubscriptionSearchOK()
...
func NewEventSubscriptionSearchOK() *EventSubscriptionSearchOK {
	return &EventSubscriptionSearchOK{}
}
...
func (o *EventSubscriptionSearchOK) Error() string {
	return fmt.Sprintf("[GET /event/subscription][%d] eventSubscriptionSearchOK  %+v", 200, o.Payload)
}

func (o *EventSubscriptionSearchOK) GetPayload() *models.ListResponseSubscription {
	return o.Payload
}

func (o *EventSubscriptionSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
