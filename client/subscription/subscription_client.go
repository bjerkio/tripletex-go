...
func (a *Client) EventSubscriptionGet(params *EventSubscriptionGetParams, authInfo runtime.ClientAuthInfoWriter) (*EventSubscriptionGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for EventSubscriptionGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EventSubscriptionPost(params *EventSubscriptionPostParams, authInfo runtime.ClientAuthInfoWriter) (*EventSubscriptionPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EventSubscriptionPost: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EventSubscriptionPut(params *EventSubscriptionPutParams, authInfo runtime.ClientAuthInfoWriter) (*EventSubscriptionPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EventSubscriptionPut: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EventSubscriptionSearch(params *EventSubscriptionSearchParams, authInfo runtime.ClientAuthInfoWriter) (*EventSubscriptionSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EventSubscriptionSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
