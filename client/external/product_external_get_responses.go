...
func (o *ProductExternalGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewProductExternalGetOK()
...
func (o *ProductExternalGetOK) Error() string {
	return fmt.Sprintf("[GET /product/external/{id}][%d] productExternalGetOK  %+v", 200, o.Payload)
}

func (o *ProductExternalGetOK) GetPayload() *models.ResponseWrapperExternalProduct {
	return o.Payload
}

func (o *ProductExternalGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
