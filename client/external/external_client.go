...
func (a *Client) ProductExternalGet(params *ProductExternalGetParams, authInfo runtime.ClientAuthInfoWriter) (*ProductExternalGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for ProductExternal_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ProductExternalSearch(params *ProductExternalSearchParams, authInfo runtime.ClientAuthInfoWriter) (*ProductExternalSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ProductExternal_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
