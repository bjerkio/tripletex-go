...
func (a *Client) PurchaseOrderGoodsReceiptLineListPostList(params *PurchaseOrderGoodsReceiptLineListPostListParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderGoodsReceiptLineListPostListCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderGoodsReceiptLineList_postList",
		Method:             "POST",
	...
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderGoodsReceiptLineList_postList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderGoodsReceiptLineDelete(params *PurchaseOrderGoodsReceiptLineDeleteParams, authInfo runtime.ClientAuthInfoWriter) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderGoodsReceiptLine_delete",
		Method:             "DELETE",
...
func (a *Client) PurchaseOrderGoodsReceiptLineGet(params *PurchaseOrderGoodsReceiptLineGetParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderGoodsReceiptLineGetOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderGoodsReceiptLine_get",
		Method:             "GET",
		PathPattern:        "/purchaseOrder/goodsReceiptLine/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderGoodsReceiptLine_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderGoodsReceiptLinePost(params *PurchaseOrderGoodsReceiptLinePostParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderGoodsReceiptLinePostCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderGoodsReceiptLine_post",
		Method:             "POST",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderGoodsReceiptLine_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderGoodsReceiptLinePut(params *PurchaseOrderGoodsReceiptLinePutParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderGoodsReceiptLinePutOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderGoodsReceiptLine_put",
		Method:             "PUT",
		PathPattern:        "/purchaseOrder/goodsReceiptLine/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json; charset=utf-8"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderGoodsReceiptLine_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderGoodsReceiptLineSearch(params *PurchaseOrderGoodsReceiptLineSearchParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderGoodsReceiptLineSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderGoodsReceiptLine_search",
		Method:             "GET",
		PathPattern:        "/purchaseOrder/goodsReceiptLine",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderGoodsReceiptLine_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
