...
func (o *EmployeeSearchOK) Error() string {
	return fmt.Sprintf("[GET /employee][%d] employeeSearchOK  %+v", 200, o.Payload)
}
...
func (o *EmployeeSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
