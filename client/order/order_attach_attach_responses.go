...
func (o *OrderAttachAttachOK) Error() string {
	return fmt.Sprintf("[PUT /order/{id}/:attach][%d] orderAttachAttachOK  %+v", 200, o.Payload)
}
...
func (o *OrderAttachAttachOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
