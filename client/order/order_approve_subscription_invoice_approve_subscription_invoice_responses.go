...
func (o *OrderApproveSubscriptionInvoiceApproveSubscriptionInvoiceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewOrderApproveSubscriptionInvoiceApproveSubscriptionInvoiceOK()
...
func NewOrderApproveSubscriptionInvoiceApproveSubscriptionInvoiceOK() *OrderApproveSubscriptionInvoiceApproveSubscriptionInvoiceOK {
	return &OrderApproveSubscriptionInvoiceApproveSubscriptionInvoiceOK{}
}
...
func (o *OrderApproveSubscriptionInvoiceApproveSubscriptionInvoiceOK) Error() string {
	return fmt.Sprintf("[PUT /order/{id}/:approveSubscriptionInvoice][%d] orderApproveSubscriptionInvoiceApproveSubscriptionInvoiceOK  %+v", 200, o.Payload)
}
...
func (o *OrderApproveSubscriptionInvoiceApproveSubscriptionInvoiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
