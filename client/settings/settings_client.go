...
func (a *Client) SalarySettingsGet(params *SalarySettingsGetParams, authInfo runtime.ClientAuthInfoWriter) (*SalarySettingsGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for SalarySettings_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SalarySettingsPut(params *SalarySettingsPutParams, authInfo runtime.ClientAuthInfoWriter) (*SalarySettingsPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for SalarySettings_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TimesheetSettingsGet(params *TimesheetSettingsGetParams, authInfo runtime.ClientAuthInfoWriter) (*TimesheetSettingsGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TimesheetSettings_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TravelExpenseSettingsGet(params *TravelExpenseSettingsGetParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpenseSettingsGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TravelExpenseSettings_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
