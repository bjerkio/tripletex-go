...
func (a *Client) EmployeeEmploymentOccupationCodeSearch(params *EmployeeEmploymentOccupationCodeSearchParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentOccupationCodeSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeEmploymentOccupationCodeSearch",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentOccupationCodeSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
