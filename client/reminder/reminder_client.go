...
func (a *Client) ReminderGet(params *ReminderGetParams, authInfo runtime.ClientAuthInfoWriter) (*ReminderGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for ReminderGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ReminderSearch(params *ReminderSearchParams, authInfo runtime.ClientAuthInfoWriter) (*ReminderSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ReminderSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
