...
func (o *ProjectOrderlineListPostListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewProjectOrderlineListPostListCreated()
...
func NewProjectOrderlineListPostListCreated() *ProjectOrderlineListPostListCreated {
	return &ProjectOrderlineListPostListCreated{}
}
...
func (o *ProjectOrderlineListPostListCreated) Error() string {
	return fmt.Sprintf("[POST /project/orderline/list][%d] projectOrderlineListPostListCreated  %+v", 201, o.Payload)
}

func (o *ProjectOrderlineListPostListCreated) GetPayload() *models.ListResponseProjectOrderLine {
	return o.Payload
}

func (o *ProjectOrderlineListPostListCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
