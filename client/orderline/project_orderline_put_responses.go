...
func (o *ProjectOrderlinePutReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewProjectOrderlinePutOK()
...
func (o *ProjectOrderlinePutOK) Error() string {
	return fmt.Sprintf("[PUT /project/orderline/{id}][%d] projectOrderlinePutOK  %+v", 200, o.Payload)
}

func (o *ProjectOrderlinePutOK) GetPayload() *models.ResponseWrapperProjectOrderLine {
	return o.Payload
}

func (o *ProjectOrderlinePutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
