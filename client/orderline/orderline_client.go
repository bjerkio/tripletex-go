...
func (a *Client) OrderOrderlineListPostList(params *OrderOrderlineListPostListParams, authInfo runtime.ClientAuthInfoWriter) (*OrderOrderlineListPostListCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "OrderOrderlineList_postList",
		Method:             "POST",
	...
	msg := fmt.Sprintf("unexpected success response for OrderOrderlineList_postList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) OrderOrderlineGet(params *OrderOrderlineGetParams, authInfo runtime.ClientAuthInfoWriter) (*OrderOrderlineGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for OrderOrderline_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) OrderOrderlinePost(params *OrderOrderlinePostParams, authInfo runtime.ClientAuthInfoWriter) (*OrderOrderlinePostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for OrderOrderline_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) OrderOrderlinePut(params *OrderOrderlinePutParams, authInfo runtime.ClientAuthInfoWriter) (*OrderOrderlinePutOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewOrderOrderlinePutParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "OrderOrderline_put",
		Method:             "PUT",
		PathPattern:        "/order/orderline/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json; charset=utf-8"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &OrderOrderlinePutReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	...
	success, ok := result.(*OrderOrderlinePutOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for OrderOrderline_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ProjectOrderlineListPostList(params *ProjectOrderlineListPostListParams, authInfo runtime.ClientAuthInfoWriter) (*ProjectOrderlineListPostListCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "ProjectOrderlineList_postList",
		Method:             "POST",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ProjectOrderlineList_postList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ProjectOrderlineGet(params *ProjectOrderlineGetParams, authInfo runtime.ClientAuthInfoWriter) (*ProjectOrderlineGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ProjectOrderline_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ProjectOrderlinePost(params *ProjectOrderlinePostParams, authInfo runtime.ClientAuthInfoWriter) (*ProjectOrderlinePostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ProjectOrderline_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ProjectOrderlinePut(params *ProjectOrderlinePutParams, authInfo runtime.ClientAuthInfoWriter) (*ProjectOrderlinePutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ProjectOrderline_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ProjectOrderlineSearch(params *ProjectOrderlineSearchParams, authInfo runtime.ClientAuthInfoWriter) (*ProjectOrderlineSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ProjectOrderline_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderOrderlineDelete(params *PurchaseOrderOrderlineDeleteParams, authInfo runtime.ClientAuthInfoWriter) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderOrderline_delete",
		Method:             "DELETE",
...
func (a *Client) PurchaseOrderOrderlineGet(params *PurchaseOrderOrderlineGetParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderOrderlineGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderOrderline_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderOrderlinePost(params *PurchaseOrderOrderlinePostParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderOrderlinePostCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderOrderline_post",
		Method:             "POST",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderOrderline_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderOrderlinePut(params *PurchaseOrderOrderlinePutParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderOrderlinePutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderOrderline_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
