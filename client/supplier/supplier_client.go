...
type ClientService interface {
	...
	SupplierDelete(params *SupplierDeleteParams, authInfo runtime.ClientAuthInfoWriter) error
...
func (a *Client) SupplierListPostList(params *SupplierListPostListParams, authInfo runtime.ClientAuthInfoWriter) (*SupplierListPostListCreated, error) {
	...
	msg := fmt.Sprintf("unexpected success response for SupplierList_postList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SupplierListPutList(params *SupplierListPutListParams, authInfo runtime.ClientAuthInfoWriter) (*SupplierListPutListOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for SupplierList_putList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SupplierDelete(params *SupplierDeleteParams, authInfo runtime.ClientAuthInfoWriter) error {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewSupplierDeleteParams()
	}
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &SupplierDeleteReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
...
func (a *Client) SupplierGet(params *SupplierGetParams, authInfo runtime.ClientAuthInfoWriter) (*SupplierGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Supplier_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SupplierPost(params *SupplierPostParams, authInfo runtime.ClientAuthInfoWriter) (*SupplierPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Supplier_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SupplierPut(params *SupplierPutParams, authInfo runtime.ClientAuthInfoWriter) (*SupplierPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Supplier_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SupplierSearch(params *SupplierSearchParams, authInfo runtime.ClientAuthInfoWriter) (*SupplierSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Supplier_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
