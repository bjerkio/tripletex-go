...
func (o *ProjectListPutListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewProjectListPutListOK()
...
func (o *ProjectListPutListOK) Error() string {
	return fmt.Sprintf("[PUT /project/list][%d] projectListPutListOK  %+v", 200, o.Payload)
}
...
func (o *ProjectListPutListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
