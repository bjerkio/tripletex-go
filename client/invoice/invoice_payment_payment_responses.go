...
func (o *InvoicePaymentPaymentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewInvoicePaymentPaymentOK()
...
func NewInvoicePaymentPaymentOK() *InvoicePaymentPaymentOK {
	return &InvoicePaymentPaymentOK{}
}
...
func (o *InvoicePaymentPaymentOK) Error() string {
	return fmt.Sprintf("[PUT /invoice/{id}/:payment][%d] invoicePaymentPaymentOK  %+v", 200, o.Payload)
}
...
func (o *InvoicePaymentPaymentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
