...
func (o *InvoicePostCreated) Error() string {
	return fmt.Sprintf("[POST /invoice][%d] invoicePostCreated  %+v", 201, o.Payload)
}
...
func (o *InvoicePostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
