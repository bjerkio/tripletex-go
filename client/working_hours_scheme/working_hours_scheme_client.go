...
func (a *Client) EmployeeEmploymentWorkingHoursSchemeSearch(params *EmployeeEmploymentWorkingHoursSchemeSearchParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentWorkingHoursSchemeSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeEmploymentWorkingHoursSchemeSearch",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentWorkingHoursSchemeSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
