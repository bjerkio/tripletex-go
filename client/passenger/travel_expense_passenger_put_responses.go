...
func (o *TravelExpensePassengerPutReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTravelExpensePassengerPutOK()
...
func NewTravelExpensePassengerPutOK() *TravelExpensePassengerPutOK {
	return &TravelExpensePassengerPutOK{}
}
...
func (o *TravelExpensePassengerPutOK) Error() string {
	return fmt.Sprintf("[PUT /travelExpense/passenger/{id}][%d] travelExpensePassengerPutOK  %+v", 200, o.Payload)
}
...
func (o *TravelExpensePassengerPutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
