...
func (a *Client) BankStatementImportImportBankStatement(params *BankStatementImportImportBankStatementParams, authInfo runtime.ClientAuthInfoWriter) (*BankStatementImportImportBankStatementCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankStatementImport_importBankStatement",
		Method:             "POST",
	...
	msg := fmt.Sprintf("unexpected success response for BankStatementImport_importBankStatement: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankStatementGet(params *BankStatementGetParams, authInfo runtime.ClientAuthInfoWriter) (*BankStatementGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankStatement_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankStatementSearch(params *BankStatementSearchParams, authInfo runtime.ClientAuthInfoWriter) (*BankStatementSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankStatement_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
