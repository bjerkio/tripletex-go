...
func (o *ProductUnitPutOK) Error() string {
	return fmt.Sprintf("[PUT /product/unit/{id}][%d] productUnitPutOK  %+v", 200, o.Payload)
}

func (o *ProductUnitPutOK) GetPayload() *models.ResponseWrapperProductUnit {
	return o.Payload
}

func (o *ProductUnitPutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
