...
func (o *ProductUnitPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewProductUnitPostCreated()
...
func (o *ProductUnitPostCreated) Error() string {
	return fmt.Sprintf("[POST /product/unit][%d] productUnitPostCreated  %+v", 201, o.Payload)
}

func (o *ProductUnitPostCreated) GetPayload() *models.ResponseWrapperProductUnit {
	return o.Payload
}

func (o *ProductUnitPostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
