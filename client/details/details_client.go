...
func (a *Client) EmployeeEmploymentDetailsGet(params *EmployeeEmploymentDetailsGetParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentDetailsGetOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeEmploymentDetails_get",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentDetails_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeEmploymentDetailsPost(params *EmployeeEmploymentDetailsPostParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentDetailsPostCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeEmploymentDetails_post",
		Method:             "POST",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentDetails_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeEmploymentDetailsPut(params *EmployeeEmploymentDetailsPutParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentDetailsPutOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeEmploymentDetails_put",
		Method:             "PUT",
		PathPattern:        "/employee/employment/details/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json; charset=utf-8"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentDetails_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeEmploymentDetailsSearch(params *EmployeeEmploymentDetailsSearchParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentDetailsSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeEmploymentDetails_search",
		Method:             "GET",
		PathPattern:        "/employee/employment/details",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentDetails_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) InvoiceDetailsGet(params *InvoiceDetailsGetParams, authInfo runtime.ClientAuthInfoWriter) (*InvoiceDetailsGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for InvoiceDetails_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) InvoiceDetailsSearch(params *InvoiceDetailsSearchParams, authInfo runtime.ClientAuthInfoWriter) (*InvoiceDetailsSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for InvoiceDetails_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
