...
func (o *SalarySettingsHolidaySearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSalarySettingsHolidaySearchOK()
...
func NewSalarySettingsHolidaySearchOK() *SalarySettingsHolidaySearchOK {
	return &SalarySettingsHolidaySearchOK{}
}
...
func (o *SalarySettingsHolidaySearchOK) Error() string {
	return fmt.Sprintf("[GET /salary/settings/holiday][%d] salarySettingsHolidaySearchOK  %+v", 200, o.Payload)
}
...
func (o *SalarySettingsHolidaySearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
