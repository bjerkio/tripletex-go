...
func (a *Client) SalarySettingsHolidayListDeleteByIds(params *SalarySettingsHolidayListDeleteByIdsParams, authInfo runtime.ClientAuthInfoWriter) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "SalarySettingsHolidayList_deleteByIds",
		Method:             "DELETE",
...
func (a *Client) SalarySettingsHolidayListPostList(params *SalarySettingsHolidayListPostListParams, authInfo runtime.ClientAuthInfoWriter) (*SalarySettingsHolidayListPostListCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "SalarySettingsHolidayList_postList",
		Method:             "POST",
		PathPattern:        "/salary/settings/holiday/list",
		ProducesMediaTypes: []string{"application/json"},
	...
	msg := fmt.Sprintf("unexpected success response for SalarySettingsHolidayList_postList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SalarySettingsHolidayListPutList(params *SalarySettingsHolidayListPutListParams, authInfo runtime.ClientAuthInfoWriter) (*SalarySettingsHolidayListPutListOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "SalarySettingsHolidayList_putList",
		Method:             "PUT",
		PathPattern:        "/salary/settings/holiday/list",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json; charset=utf-8"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for SalarySettingsHolidayList_putList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SalarySettingsHolidayPost(params *SalarySettingsHolidayPostParams, authInfo runtime.ClientAuthInfoWriter) (*SalarySettingsHolidayPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for SalarySettingsHoliday_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SalarySettingsHolidayPut(params *SalarySettingsHolidayPutParams, authInfo runtime.ClientAuthInfoWriter) (*SalarySettingsHolidayPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for SalarySettingsHoliday_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SalarySettingsHolidaySearch(params *SalarySettingsHolidaySearchParams, authInfo runtime.ClientAuthInfoWriter) (*SalarySettingsHolidaySearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "SalarySettingsHoliday_search",
		Method:             "GET",
		PathPattern:        "/salary/settings/holiday",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for SalarySettingsHoliday_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
