...
func (o *SalaryCompilationPdfDownloadPdfReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSalaryCompilationPdfDownloadPdfOK()
...
func NewSalaryCompilationPdfDownloadPdfOK() *SalaryCompilationPdfDownloadPdfOK {
	return &SalaryCompilationPdfDownloadPdfOK{}
}
...
func (o *SalaryCompilationPdfDownloadPdfOK) Error() string {
	return fmt.Sprintf("[GET /salary/compilation/pdf][%d] salaryCompilationPdfDownloadPdfOK  %+v", 200, o.Payload)
}
...
func (o *SalaryCompilationPdfDownloadPdfOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
