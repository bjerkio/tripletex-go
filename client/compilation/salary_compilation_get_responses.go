...
func (o *SalaryCompilationGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSalaryCompilationGetOK()
...
func (o *SalaryCompilationGetOK) Error() string {
	return fmt.Sprintf("[GET /salary/compilation][%d] salaryCompilationGetOK  %+v", 200, o.Payload)
}
...
func (o *SalaryCompilationGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ResponseWrapperSalaryCompilation)
