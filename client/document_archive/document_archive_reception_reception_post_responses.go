...
func (o *DocumentArchiveReceptionReceptionPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewDocumentArchiveReceptionReceptionPostCreated()
...
func NewDocumentArchiveReceptionReceptionPostCreated() *DocumentArchiveReceptionReceptionPostCreated {
	return &DocumentArchiveReceptionReceptionPostCreated{}
}
...
func (o *DocumentArchiveReceptionReceptionPostCreated) Error() string {
	return fmt.Sprintf("[POST /documentArchive/reception][%d] documentArchiveReceptionReceptionPostCreated  %+v", 201, o.Payload)
}
...
func (o *DocumentArchiveReceptionReceptionPostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
