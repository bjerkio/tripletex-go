...
func (o *DocumentArchiveProductProductPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewDocumentArchiveProductProductPostCreated()
...
func NewDocumentArchiveProductProductPostCreated() *DocumentArchiveProductProductPostCreated {
	return &DocumentArchiveProductProductPostCreated{}
}
...
func (o *DocumentArchiveProductProductPostCreated) Error() string {
	return fmt.Sprintf("[POST /documentArchive/product/{id}][%d] documentArchiveProductProductPostCreated  %+v", 201, o.Payload)
}
...
func (o *DocumentArchiveProductProductPostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
