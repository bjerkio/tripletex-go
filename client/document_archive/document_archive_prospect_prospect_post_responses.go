...
func (o *DocumentArchiveProspectProspectPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewDocumentArchiveProspectProspectPostCreated()
...
func NewDocumentArchiveProspectProspectPostCreated() *DocumentArchiveProspectProspectPostCreated {
	return &DocumentArchiveProspectProspectPostCreated{}
}
...
func (o *DocumentArchiveProspectProspectPostCreated) Error() string {
	return fmt.Sprintf("[POST /documentArchive/prospect/{id}][%d] documentArchiveProspectProspectPostCreated  %+v", 201, o.Payload)
}
...
func (o *DocumentArchiveProspectProspectPostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
