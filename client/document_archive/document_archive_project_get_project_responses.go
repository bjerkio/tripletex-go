...
func (o *DocumentArchiveProjectGetProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDocumentArchiveProjectGetProjectOK()
...
func NewDocumentArchiveProjectGetProjectOK() *DocumentArchiveProjectGetProjectOK {
	return &DocumentArchiveProjectGetProjectOK{}
}
...
func (o *DocumentArchiveProjectGetProjectOK) Error() string {
	return fmt.Sprintf("[GET /documentArchive/project/{id}][%d] documentArchiveProjectGetProjectOK  %+v", 200, o.Payload)
}
...
func (o *DocumentArchiveProjectGetProjectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
