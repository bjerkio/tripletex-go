...
func (o *DocumentArchiveAccountGetAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDocumentArchiveAccountGetAccountOK()
...
func NewDocumentArchiveAccountGetAccountOK() *DocumentArchiveAccountGetAccountOK {
	return &DocumentArchiveAccountGetAccountOK{}
}
...
func (o *DocumentArchiveAccountGetAccountOK) Error() string {
	return fmt.Sprintf("[GET /documentArchive/account/{id}][%d] documentArchiveAccountGetAccountOK  %+v", 200, o.Payload)
}
...
func (o *DocumentArchiveAccountGetAccountOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
