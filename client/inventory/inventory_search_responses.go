...
func (o *InventorySearchOK) Error() string {
	return fmt.Sprintf("[GET /inventory][%d] inventorySearchOK  %+v", 200, o.Payload)
}
...
func (o *InventorySearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
