...
func (o *InventoryStocktakingSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewInventoryStocktakingSearchOK()
...
func NewInventoryStocktakingSearchOK() *InventoryStocktakingSearchOK {
	return &InventoryStocktakingSearchOK{}
}
...
func (o *InventoryStocktakingSearchOK) Error() string {
	return fmt.Sprintf("[GET /inventory/stocktaking][%d] inventoryStocktakingSearchOK  %+v", 200, o.Payload)
}
...
func (o *InventoryStocktakingSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ListResponseStocktaking)
