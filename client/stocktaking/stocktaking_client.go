...
func (a *Client) InventoryStocktakingDelete(params *InventoryStocktakingDeleteParams, authInfo runtime.ClientAuthInfoWriter) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "InventoryStocktaking_delete",
		Method:             "DELETE",
...
func (a *Client) InventoryStocktakingGet(params *InventoryStocktakingGetParams, authInfo runtime.ClientAuthInfoWriter) (*InventoryStocktakingGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for InventoryStocktaking_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) InventoryStocktakingPost(params *InventoryStocktakingPostParams, authInfo runtime.ClientAuthInfoWriter) (*InventoryStocktakingPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for InventoryStocktaking_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) InventoryStocktakingPut(params *InventoryStocktakingPutParams, authInfo runtime.ClientAuthInfoWriter) (*InventoryStocktakingPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for InventoryStocktaking_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) InventoryStocktakingSearch(params *InventoryStocktakingSearchParams, authInfo runtime.ClientAuthInfoWriter) (*InventoryStocktakingSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "InventoryStocktaking_search",
		Method:             "GET",
		PathPattern:        "/inventory/stocktaking",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for InventoryStocktaking_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
