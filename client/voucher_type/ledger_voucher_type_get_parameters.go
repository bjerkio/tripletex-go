...
// NewLedgerVoucherTypeGetParams creates a new LedgerVoucherTypeGetParams object
// with the default values initialized.
func NewLedgerVoucherTypeGetParams() *LedgerVoucherTypeGetParams {
	var ()
	return &LedgerVoucherTypeGetParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewLedgerVoucherTypeGetParamsWithTimeout creates a new LedgerVoucherTypeGetParams object
...
// NewLedgerVoucherTypeGetParamsWithContext creates a new LedgerVoucherTypeGetParams object
...
// NewLedgerVoucherTypeGetParamsWithHTTPClient creates a new LedgerVoucherTypeGetParams object
...
/*LedgerVoucherTypeGetParams contains all the parameters to send to the API endpoint
for the ledger voucher type get operation typically these are written to a http.Request
*/
...
func (o *LedgerVoucherTypeGetParams) WithTimeout(timeout time.Duration) *LedgerVoucherTypeGetParams {
...
func (o *LedgerVoucherTypeGetParams) WithContext(ctx context.Context) *LedgerVoucherTypeGetParams {
	o.SetContext(ctx)
	return o
}
...
func (o *LedgerVoucherTypeGetParams) WithHTTPClient(client *http.Client) *LedgerVoucherTypeGetParams {
...
func (o *LedgerVoucherTypeGetParams) WithFields(fields *string) *LedgerVoucherTypeGetParams {
	o.SetFields(fields)
	return o
}
...
func (o *LedgerVoucherTypeGetParams) WithID(id int32) *LedgerVoucherTypeGetParams {
	o.SetID(id)
	return o
}
...
func (o *LedgerVoucherTypeGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
