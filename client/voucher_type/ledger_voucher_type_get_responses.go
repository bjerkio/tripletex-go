...
func (o *LedgerVoucherTypeGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewLedgerVoucherTypeGetOK()
...
func (o *LedgerVoucherTypeGetOK) Error() string {
	return fmt.Sprintf("[GET /ledger/voucherType/{id}][%d] ledgerVoucherTypeGetOK  %+v", 200, o.Payload)
}

func (o *LedgerVoucherTypeGetOK) GetPayload() *models.ResponseWrapperVoucherType {
	return o.Payload
}

func (o *LedgerVoucherTypeGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
