...
func (a *Client) LedgerVoucherTypeGet(params *LedgerVoucherTypeGetParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerVoucherTypeGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for LedgerVoucherTypeGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) LedgerVoucherTypeSearch(params *LedgerVoucherTypeSearchParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerVoucherTypeSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for LedgerVoucherTypeSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
