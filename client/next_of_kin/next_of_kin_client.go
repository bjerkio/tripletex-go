...
func (a *Client) EmployeeNextOfKinGet(params *EmployeeNextOfKinGetParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeNextOfKinGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for EmployeeNextOfKinGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeNextOfKinPost(params *EmployeeNextOfKinPostParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeNextOfKinPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeNextOfKinPost: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeNextOfKinPut(params *EmployeeNextOfKinPutParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeNextOfKinPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeNextOfKinPut: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) EmployeeNextOfKinSearch(params *EmployeeNextOfKinSearchParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeNextOfKinSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for EmployeeNextOfKinSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
