...
func (o *EmployeeNextOfKinPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewEmployeeNextOfKinPostCreated()
...
func NewEmployeeNextOfKinPostCreated() *EmployeeNextOfKinPostCreated {
	return &EmployeeNextOfKinPostCreated{}
}
...
func (o *EmployeeNextOfKinPostCreated) Error() string {
	return fmt.Sprintf("[POST /employee/nextOfKin][%d] employeeNextOfKinPostCreated  %+v", 201, o.Payload)
}

func (o *EmployeeNextOfKinPostCreated) GetPayload() *models.ResponseWrapperNextOfKin {
	return o.Payload
}

func (o *EmployeeNextOfKinPostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
