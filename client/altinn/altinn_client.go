...
func (a *Client) CompanySettingsAltinnPut(params *CompanySettingsAltinnPutParams, authInfo runtime.ClientAuthInfoWriter) (*CompanySettingsAltinnPutOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for CompanySettingsAltinn_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) CompanySettingsAltinnSearch(params *CompanySettingsAltinnSearchParams, authInfo runtime.ClientAuthInfoWriter) (*CompanySettingsAltinnSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "CompanySettingsAltinn_search",
		Method:             "GET",
		PathPattern:        "/company/settings/altinn",
		ProducesMediaTypes: []string{"application/json"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for CompanySettingsAltinn_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
