...
func (a *Client) LedgerAccountingPeriodGet(params *LedgerAccountingPeriodGetParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerAccountingPeriodGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for LedgerAccountingPeriod_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) LedgerAccountingPeriodSearch(params *LedgerAccountingPeriodSearchParams, authInfo runtime.ClientAuthInfoWriter) (*LedgerAccountingPeriodSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "LedgerAccountingPeriod_search",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for LedgerAccountingPeriod_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
