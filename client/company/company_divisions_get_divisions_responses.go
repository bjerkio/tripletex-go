...
func (o *CompanyDivisionsGetDivisionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCompanyDivisionsGetDivisionsOK()
...
func NewCompanyDivisionsGetDivisionsOK() *CompanyDivisionsGetDivisionsOK {
	return &CompanyDivisionsGetDivisionsOK{}
}
...
func (o *CompanyDivisionsGetDivisionsOK) Error() string {
	return fmt.Sprintf("[GET /company/divisions][%d] companyDivisionsGetDivisionsOK  %+v", 200, o.Payload)
}
...
func (o *CompanyDivisionsGetDivisionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
