...
func (o *CompanyGetOK) Error() string {
	return fmt.Sprintf("[GET /company/{id}][%d] companyGetOK  %+v", 200, o.Payload)
}
...
func (o *CompanyGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
