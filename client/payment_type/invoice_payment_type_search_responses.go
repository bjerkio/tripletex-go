...
func (o *InvoicePaymentTypeSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewInvoicePaymentTypeSearchOK()
...
func NewInvoicePaymentTypeSearchOK() *InvoicePaymentTypeSearchOK {
	return &InvoicePaymentTypeSearchOK{}
}
...
func (o *InvoicePaymentTypeSearchOK) Error() string {
	return fmt.Sprintf("[GET /invoice/paymentType][%d] invoicePaymentTypeSearchOK  %+v", 200, o.Payload)
}
...
func (o *InvoicePaymentTypeSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
