...
func (a *Client) BankReconciliationPaymentTypeGet(params *BankReconciliationPaymentTypeGetParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationPaymentTypeGetOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankReconciliationPaymentType_get",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for BankReconciliationPaymentType_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) BankReconciliationPaymentTypeSearch(params *BankReconciliationPaymentTypeSearchParams, authInfo runtime.ClientAuthInfoWriter) (*BankReconciliationPaymentTypeSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "BankReconciliationPaymentType_search",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BankReconciliationPaymentType_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) InvoicePaymentTypeGet(params *InvoicePaymentTypeGetParams, authInfo runtime.ClientAuthInfoWriter) (*InvoicePaymentTypeGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for InvoicePaymentType_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) InvoicePaymentTypeSearch(params *InvoicePaymentTypeSearchParams, authInfo runtime.ClientAuthInfoWriter) (*InvoicePaymentTypeSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for InvoicePaymentType_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TravelExpensePaymentTypeGet(params *TravelExpensePaymentTypeGetParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpensePaymentTypeGetOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TravelExpensePaymentType_get",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TravelExpensePaymentType_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TravelExpensePaymentTypeSearch(params *TravelExpensePaymentTypeSearchParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpensePaymentTypeSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TravelExpensePaymentType_search",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TravelExpensePaymentType_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
