...
// NewTokenSessionDeleteParams creates a new TokenSessionDeleteParams object
// with the default values initialized.
func NewTokenSessionDeleteParams() *TokenSessionDeleteParams {
	var ()
	return &TokenSessionDeleteParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewTokenSessionDeleteParamsWithTimeout creates a new TokenSessionDeleteParams object
...
// NewTokenSessionDeleteParamsWithContext creates a new TokenSessionDeleteParams object
...
// NewTokenSessionDeleteParamsWithHTTPClient creates a new TokenSessionDeleteParams object
...
/*TokenSessionDeleteParams contains all the parameters to send to the API endpoint
for the token session delete operation typically these are written to a http.Request
*/
...
func (o *TokenSessionDeleteParams) WithTimeout(timeout time.Duration) *TokenSessionDeleteParams {
...
func (o *TokenSessionDeleteParams) WithContext(ctx context.Context) *TokenSessionDeleteParams {
	o.SetContext(ctx)
	return o
}
...
func (o *TokenSessionDeleteParams) WithToken(token string) *TokenSessionDeleteParams {
	o.SetToken(token)
	return o
}
...
func (o *TokenSessionDeleteParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
