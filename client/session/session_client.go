...
func (a *Client) TokenSessionCreateCreate(params *TokenSessionCreateCreateParams) (*TokenSessionCreateCreateOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for TokenSessionCreate_create: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TokenSessionWhoAmIWhoAmI(params *TokenSessionWhoAmIWhoAmIParams, authInfo runtime.ClientAuthInfoWriter) (*TokenSessionWhoAmIWhoAmIOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TokenSessionWhoAmI_whoAmI: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
