...
func (o *CrmProspectGetOK) Error() string {
	return fmt.Sprintf("[GET /crm/prospect/{id}][%d] crmProspectGetOK  %+v", 200, o.Payload)
}
...
func (o *CrmProspectGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
