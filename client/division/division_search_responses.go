...
func (o *DivisionSearchOK) Error() string {
	return fmt.Sprintf("[GET /division][%d] divisionSearchOK  %+v", 200, o.Payload)
}
...
func (o *DivisionSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
