...
func (a *Client) DeliveryAddressGet(params *DeliveryAddressGetParams, authInfo runtime.ClientAuthInfoWriter) (*DeliveryAddressGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for DeliveryAddress_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) DeliveryAddressPut(params *DeliveryAddressPutParams, authInfo runtime.ClientAuthInfoWriter) (*DeliveryAddressPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for DeliveryAddress_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) DeliveryAddressSearch(params *DeliveryAddressSearchParams, authInfo runtime.ClientAuthInfoWriter) (*DeliveryAddressSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for DeliveryAddress_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
