...
func (o *LedgerVoucherSendToLedgerSendToLedgerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewLedgerVoucherSendToLedgerSendToLedgerOK()
...
func NewLedgerVoucherSendToLedgerSendToLedgerOK() *LedgerVoucherSendToLedgerSendToLedgerOK {
	return &LedgerVoucherSendToLedgerSendToLedgerOK{}
}
...
func (o *LedgerVoucherSendToLedgerSendToLedgerOK) Error() string {
	return fmt.Sprintf("[PUT /ledger/voucher/{id}/:sendToLedger][%d] ledgerVoucherSendToLedgerSendToLedgerOK  %+v", 200, o.Payload)
}
...
func (o *LedgerVoucherSendToLedgerSendToLedgerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
