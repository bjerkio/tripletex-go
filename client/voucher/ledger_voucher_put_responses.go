...
func (o *LedgerVoucherPutOK) Error() string {
	return fmt.Sprintf("[PUT /ledger/voucher/{id}][%d] ledgerVoucherPutOK  %+v", 200, o.Payload)
}
...
func (o *LedgerVoucherPutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
