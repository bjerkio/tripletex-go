...
func (o *LedgerVoucherListPutListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewLedgerVoucherListPutListOK()
...
func NewLedgerVoucherListPutListOK() *LedgerVoucherListPutListOK {
	return &LedgerVoucherListPutListOK{}
}
...
func (o *LedgerVoucherListPutListOK) Error() string {
	return fmt.Sprintf("[PUT /ledger/voucher/list][%d] ledgerVoucherListPutListOK  %+v", 200, o.Payload)
}
...
func (o *LedgerVoucherListPutListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
