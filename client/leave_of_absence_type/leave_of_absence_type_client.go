...
func (a *Client) EmployeeEmploymentLeaveOfAbsenceTypeSearch(params *EmployeeEmploymentLeaveOfAbsenceTypeSearchParams, authInfo runtime.ClientAuthInfoWriter) (*EmployeeEmploymentLeaveOfAbsenceTypeSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "EmployeeEmploymentLeaveOfAbsenceType_search",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for EmployeeEmploymentLeaveOfAbsenceType_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
