...
func (o *TravelExpensePutOK) Error() string {
	return fmt.Sprintf("[PUT /travelExpense/{id}][%d] travelExpensePutOK  %+v", 200, o.Payload)
}
...
func (o *TravelExpensePutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
