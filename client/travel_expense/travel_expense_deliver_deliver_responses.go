...
func (o *TravelExpenseDeliverDeliverReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTravelExpenseDeliverDeliverOK()
...
func NewTravelExpenseDeliverDeliverOK() *TravelExpenseDeliverDeliverOK {
	return &TravelExpenseDeliverDeliverOK{}
}
...
func (o *TravelExpenseDeliverDeliverOK) Error() string {
	return fmt.Sprintf("[PUT /travelExpense/:deliver][%d] travelExpenseDeliverDeliverOK  %+v", 200, o.Payload)
}
...
func (o *TravelExpenseDeliverDeliverOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
