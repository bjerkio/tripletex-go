...
func (o *TravelExpenseSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTravelExpenseSearchOK()
...
func (o *TravelExpenseSearchOK) Error() string {
	return fmt.Sprintf("[GET /travelExpense][%d] travelExpenseSearchOK  %+v", 200, o.Payload)
}
...
func (o *TravelExpenseSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
