...
func (o *ProductSearchOK) Error() string {
	return fmt.Sprintf("[GET /product][%d] productSearchOK  %+v", 200, o.Payload)
}
...
func (o *ProductSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
