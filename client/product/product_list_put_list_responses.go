...
func (o *ProductListPutListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewProductListPutListOK()
...
func (o *ProductListPutListOK) Error() string {
	return fmt.Sprintf("[PUT /product/list][%d] productListPutListOK  %+v", 200, o.Payload)
}

func (o *ProductListPutListOK) GetPayload() *models.ListResponseProduct {
	return o.Payload
}

func (o *ProductListPutListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
