...
func (o *EmployeeEntitlementGrantClientEntitlementsByTemplateGrantClientEntitlementsByTemplateDefault) Error() string {
	return fmt.Sprintf("[PUT /employee/entitlement/:grantClientEntitlementsByTemplate][%d] EmployeeEntitlementGrantClientEntitlementsByTemplateGrantClientEntitlementsByTemplate default ", o._statusCode)
}
