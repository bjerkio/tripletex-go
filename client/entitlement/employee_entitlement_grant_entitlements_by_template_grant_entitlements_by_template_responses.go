...
func (o *EmployeeEntitlementGrantEntitlementsByTemplateGrantEntitlementsByTemplateDefault) Error() string {
	return fmt.Sprintf("[PUT /employee/entitlement/:grantEntitlementsByTemplate][%d] EmployeeEntitlementGrantEntitlementsByTemplate_grantEntitlementsByTemplate default ", o._statusCode)
}
