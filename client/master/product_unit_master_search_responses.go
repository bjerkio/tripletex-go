...
func (o *ProductUnitMasterSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewProductUnitMasterSearchOK()
...
func NewProductUnitMasterSearchOK() *ProductUnitMasterSearchOK {
	return &ProductUnitMasterSearchOK{}
}
...
func (o *ProductUnitMasterSearchOK) Error() string {
	return fmt.Sprintf("[GET /product/unit/master][%d] productUnitMasterSearchOK  %+v", 200, o.Payload)
}
...
func (o *ProductUnitMasterSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ListResponseProductUnitMaster)
