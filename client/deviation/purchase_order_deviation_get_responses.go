...
func (o *PurchaseOrderDeviationGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPurchaseOrderDeviationGetOK()
...
func NewPurchaseOrderDeviationGetOK() *PurchaseOrderDeviationGetOK {
	return &PurchaseOrderDeviationGetOK{}
}
...
func (o *PurchaseOrderDeviationGetOK) Error() string {
	return fmt.Sprintf("[GET /purchaseOrder/deviation/{id}][%d] purchaseOrderDeviationGetOK  %+v", 200, o.Payload)
}
...
func (o *PurchaseOrderDeviationGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
