...
func (o *PurchaseOrderDeviationSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPurchaseOrderDeviationSearchOK()
...
func NewPurchaseOrderDeviationSearchOK() *PurchaseOrderDeviationSearchOK {
	return &PurchaseOrderDeviationSearchOK{}
}
...
func (o *PurchaseOrderDeviationSearchOK) Error() string {
	return fmt.Sprintf("[GET /purchaseOrder/deviation][%d] purchaseOrderDeviationSearchOK  %+v", 200, o.Payload)
}
...
func (o *PurchaseOrderDeviationSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
