...
func (a *Client) PurchaseOrderDeviationApproveApprove(params *PurchaseOrderDeviationApproveApproveParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderDeviationApproveApproveOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderDeviationApprove_approve",
		Method:             "PUT",
	...
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderDeviationApprove_approve: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderDeviationDeliverDeliver(params *PurchaseOrderDeviationDeliverDeliverParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderDeviationDeliverDeliverOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderDeviationDeliver_deliver",
		Method:             "PUT",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderDeviationDeliver_deliver: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderDeviationListPostList(params *PurchaseOrderDeviationListPostListParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderDeviationListPostListCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderDeviationList_postList",
		Method:             "POST",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderDeviationList_postList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderDeviationListPutList(params *PurchaseOrderDeviationListPutListParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderDeviationListPutListOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderDeviationList_putList",
		Method:             "PUT",
		PathPattern:        "/purchaseOrder/deviation/list",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json; charset=utf-8"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderDeviationList_putList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderDeviationUndeliverUndeliver(params *PurchaseOrderDeviationUndeliverUndeliverParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderDeviationUndeliverUndeliverOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderDeviationUndeliver_undeliver",
		Method:             "PUT",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderDeviationUndeliver_undeliver: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderDeviationDelete(params *PurchaseOrderDeviationDeleteParams, authInfo runtime.ClientAuthInfoWriter) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderDeviation_delete",
		Method:             "DELETE",
...
func (a *Client) PurchaseOrderDeviationGet(params *PurchaseOrderDeviationGetParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderDeviationGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderDeviation_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderDeviationPost(params *PurchaseOrderDeviationPostParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderDeviationPostCreated, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderDeviation_post",
		Method:             "POST",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderDeviation_post: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderDeviationPut(params *PurchaseOrderDeviationPutParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderDeviationPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderDeviation_put: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderDeviationSearch(params *PurchaseOrderDeviationSearchParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderDeviationSearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderDeviation_search",
		Method:             "GET",
		PathPattern:        "/purchaseOrder/deviation",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderDeviation_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
