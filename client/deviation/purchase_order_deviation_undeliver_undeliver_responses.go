...
func (o *PurchaseOrderDeviationUndeliverUndeliverReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPurchaseOrderDeviationUndeliverUndeliverOK()
...
func NewPurchaseOrderDeviationUndeliverUndeliverOK() *PurchaseOrderDeviationUndeliverUndeliverOK {
	return &PurchaseOrderDeviationUndeliverUndeliverOK{}
}
...
func (o *PurchaseOrderDeviationUndeliverUndeliverOK) Error() string {
	return fmt.Sprintf("[PUT /purchaseOrder/deviation/{id}/:undeliver][%d] purchaseOrderDeviationUndeliverUndeliverOK  %+v", 200, o.Payload)
}
...
func (o *PurchaseOrderDeviationUndeliverUndeliverOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
