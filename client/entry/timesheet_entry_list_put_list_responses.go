...
func (o *TimesheetEntryListPutListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTimesheetEntryListPutListOK()
...
func NewTimesheetEntryListPutListOK() *TimesheetEntryListPutListOK {
	return &TimesheetEntryListPutListOK{}
}
...
func (o *TimesheetEntryListPutListOK) Error() string {
	return fmt.Sprintf("[PUT /timesheet/entry/list][%d] timesheetEntryListPutListOK  %+v", 200, o.Payload)
}
...
func (o *TimesheetEntryListPutListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
