...
func (o *TimesheetEntryPutOK) Error() string {
	return fmt.Sprintf("[PUT /timesheet/entry/{id}][%d] timesheetEntryPutOK  %+v", 200, o.Payload)
}
...
func (o *TimesheetEntryPutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
