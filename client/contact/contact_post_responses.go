...
func (o *ContactPostCreated) Error() string {
	return fmt.Sprintf("[POST /contact][%d] contactPostCreated  %+v", 201, o.Payload)
}

func (o *ContactPostCreated) GetPayload() *models.ResponseWrapperContact {
	return o.Payload
}

func (o *ContactPostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
