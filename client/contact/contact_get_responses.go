...
func (o *ContactGetOK) Error() string {
	return fmt.Sprintf("[GET /contact/{id}][%d] contactGetOK  %+v", 200, o.Payload)
}
...
func (o *ContactGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
