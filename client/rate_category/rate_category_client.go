...
func (a *Client) TravelExpenseRateCategoryGet(params *TravelExpenseRateCategoryGetParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpenseRateCategoryGetOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TravelExpenseRateCategoryGet",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for TravelExpenseRateCategoryGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TravelExpenseRateCategorySearch(params *TravelExpenseRateCategorySearchParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpenseRateCategorySearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TravelExpenseRateCategorySearch",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TravelExpenseRateCategorySearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
