...
func (a *Client) TravelExpenseCostCategoryGet(params *TravelExpenseCostCategoryGetParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpenseCostCategoryGetOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TravelExpenseCostCategory_get",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for TravelExpenseCostCategory_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) TravelExpenseCostCategorySearch(params *TravelExpenseCostCategorySearchParams, authInfo runtime.ClientAuthInfoWriter) (*TravelExpenseCostCategorySearchOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "TravelExpenseCostCategory_search",
		Method:             "GET",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for TravelExpenseCostCategory_search: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
