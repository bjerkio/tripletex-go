...
func (o *EmployeeCategorySearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewEmployeeCategorySearchOK()
...
func NewEmployeeCategorySearchOK() *EmployeeCategorySearchOK {
	return &EmployeeCategorySearchOK{}
}
...
func (o *EmployeeCategorySearchOK) Error() string {
	return fmt.Sprintf("[GET /employee/category][%d] employeeCategorySearchOK  %+v", 200, o.Payload)
}
...
func (o *EmployeeCategorySearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
