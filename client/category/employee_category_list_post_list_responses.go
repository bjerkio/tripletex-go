...
func (o *EmployeeCategoryListPostListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewEmployeeCategoryListPostListCreated()
...
func NewEmployeeCategoryListPostListCreated() *EmployeeCategoryListPostListCreated {
	return &EmployeeCategoryListPostListCreated{}
}
...
func (o *EmployeeCategoryListPostListCreated) Error() string {
	return fmt.Sprintf("[POST /employee/category/list][%d] employeeCategoryListPostListCreated  %+v", 201, o.Payload)
}
...
func (o *EmployeeCategoryListPostListCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
