...
func (o *DocumentContentDownloadContentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDocumentContentDownloadContentOK()
...
func NewDocumentContentDownloadContentOK() *DocumentContentDownloadContentOK {
	return &DocumentContentDownloadContentOK{}
}
...
func (o *DocumentContentDownloadContentOK) Error() string {
	return fmt.Sprintf("[GET /document/{id}/content][%d] documentContentDownloadContentOK  %+v", 200, o.Payload)
}

func (o *DocumentContentDownloadContentOK) GetPayload() strfmt.Base64 {
	return o.Payload
}

func (o *DocumentContentDownloadContentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
