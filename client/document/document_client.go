...
func (a *Client) DocumentContentDownloadContent(params *DocumentContentDownloadContentParams, authInfo runtime.ClientAuthInfoWriter) (*DocumentContentDownloadContentOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "DocumentContent_downloadContent",
		Method:             "GET",
	...
	msg := fmt.Sprintf("unexpected success response for DocumentContent_downloadContent: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) DocumentGet(params *DocumentGetParams, authInfo runtime.ClientAuthInfoWriter) (*DocumentGetOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Document_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
