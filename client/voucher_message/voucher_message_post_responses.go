...
func (o *VoucherMessagePostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewVoucherMessagePostCreated()
...
func NewVoucherMessagePostCreated() *VoucherMessagePostCreated {
	return &VoucherMessagePostCreated{}
}
...
func (o *VoucherMessagePostCreated) Error() string {
	return fmt.Sprintf("[POST /voucherMessage][%d] voucherMessagePostCreated  %+v", 201, o.Payload)
}

func (o *VoucherMessagePostCreated) GetPayload() *models.ResponseWrapperVoucherMessage {
	return o.Payload
}

func (o *VoucherMessagePostCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ResponseWrapperVoucherMessage)
