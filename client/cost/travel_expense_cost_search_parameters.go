...
func (o *TravelExpenseCostSearchParams) WithAmountFrom(amountFrom *float64) *TravelExpenseCostSearchParams {
	o.SetAmountFrom(amountFrom)
	return o
}

// SetAmountFrom adds the amountFrom to the travel expense cost search params
func (o *TravelExpenseCostSearchParams) SetAmountFrom(amountFrom *float64) {
	o.AmountFrom = amountFrom
}

// WithAmountTo adds the amountTo to the travel expense cost search params
func (o *TravelExpenseCostSearchParams) WithAmountTo(amountTo *float64) *TravelExpenseCostSearchParams {
	o.SetAmountTo(amountTo)
	return o
}

// SetAmountTo adds the amountTo to the travel expense cost search params
func (o *TravelExpenseCostSearchParams) SetAmountTo(amountTo *float64) {
	o.AmountTo = amountTo
}
...
func (o *TravelExpenseCostSearchParams) WithRateFrom(rateFrom *float64) *TravelExpenseCostSearchParams {
	o.SetRateFrom(rateFrom)
	return o
}

// SetRateFrom adds the rateFrom to the travel expense cost search params
func (o *TravelExpenseCostSearchParams) SetRateFrom(rateFrom *float64) {
	o.RateFrom = rateFrom
}

// WithRateTo adds the rateTo to the travel expense cost search params
func (o *TravelExpenseCostSearchParams) WithRateTo(rateTo *float64) *TravelExpenseCostSearchParams {
	o.SetRateTo(rateTo)
	return o
}

// SetRateTo adds the rateTo to the travel expense cost search params
func (o *TravelExpenseCostSearchParams) SetRateTo(rateTo *float64) {
	o.RateTo = rateTo
}
