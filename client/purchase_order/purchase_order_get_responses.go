...
func (o *PurchaseOrderGetOK) Error() string {
	return fmt.Sprintf("[GET /purchaseOrder/{id}][%d] purchaseOrderGetOK  %+v", 200, o.Payload)
}
...
func (o *PurchaseOrderGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
