...
func (a *Client) PurchaseOrderGet(params *PurchaseOrderGetParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderPost(params *PurchaseOrderPostParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderPostCreated, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderPost: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderPut(params *PurchaseOrderPutParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderPutOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderPut: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderSearch(params *PurchaseOrderSearchParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderSendByEmailSendByEmail(params *PurchaseOrderSendByEmailSendByEmailParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderSendByEmailSendByEmailOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PurchaseOrderSendByEmailSendByEmail",
		Method:             "PUT",
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderSendByEmailSendByEmail: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PurchaseOrderSendSend(params *PurchaseOrderSendSendParams, authInfo runtime.ClientAuthInfoWriter) (*PurchaseOrderSendSendOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PurchaseOrderSendSend: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
