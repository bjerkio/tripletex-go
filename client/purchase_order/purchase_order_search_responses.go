...
func (o *PurchaseOrderSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPurchaseOrderSearchOK()
...
func (o *PurchaseOrderSearchOK) Error() string {
	return fmt.Sprintf("[GET /purchaseOrder][%d] purchaseOrderSearchOK  %+v", 200, o.Payload)
}
...
func (o *PurchaseOrderSearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ListResponsePurchaseOrder)
