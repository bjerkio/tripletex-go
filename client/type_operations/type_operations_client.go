...
func (a *Client) SalaryTypeGet(params *SalaryTypeGetParams, authInfo runtime.ClientAuthInfoWriter) (*SalaryTypeGetOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for SalaryTypeGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) SalaryTypeSearch(params *SalaryTypeSearchParams, authInfo runtime.ClientAuthInfoWriter) (*SalaryTypeSearchOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for SalaryTypeSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
